/// Compat pair_key = **상대(album)의 supabaseId 단독**.
///
...
/// unlocks PK 는 (user_id=내 auth uid, pair_key=상대 id) — 상대당 1 unlock.
library;

import 'package:face_engine/domain/models/face_reading_report.dart';

/// 상대(album)의 supabaseId 를 pair_key 로 반환. 상대 id 가 null 이면 null.
