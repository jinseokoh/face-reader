...
| 날짜 | 작업 | 결과 |
|---|---|---|
| 2026-05-21 | intimacy gate 폐기 + 3-tone narrative (pure/newspaper/tabloid) | 모든 페어에서 intimacy score 항상 계산·노출. 동성/10대/70+ → pure(현재), 20대·60대 → newspaper(릴스 톤), 30~50 이성 양쪽 → tabloid(들킴 분위기). label threshold 새 분포(90.5/81.5/61.5)로 재calibrate. |
