...
| 문서 | 목적 |
|---|---|
| [PHYSIOGNOMY_TAXONOMY.md](PHYSIOGNOMY_TAXONOMY.md) | 14-node 관상 트리 SSOT: 삼정(三停) + 오관/오악/사독/십이궁 메타데이터 오버레이 |
| [TAXONOMY_METRIC_MAPPING.md](TAXONOMY_METRIC_MAPPING.md) | 트리 노드별 metric 매핑 현황, 밸런스 진단, 공백 분석 |
