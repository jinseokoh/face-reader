...
class _CompatibilityInfoDialogState extends State<CompatibilityInfoDialog>
  ...
  static const _paragraphs = [
    ...
    '본 앱의 궁합 분석은 기정의된 단순한 답변 조합이 아닙니다. '
        '전문가의 영역에서 보다 개인화된 내용을 전달하기 위해 '
        'AI를 활용한 복합적인 분석 과정을 거칩니다. '
        '이 때문에 결과를 받아보는 데까지 최대 10분의 시간이 필요할 수 있으니 '
        '잠시 여유를 가지고 기다려 주시기 바랍니다.',
    '궁합 결과 역시 관상학적 해석에 기반한 것이므로 '
        '재미와 참고의 영역으로 받아들여 주시기 바랍니다. '
        '두 사람의 관계는 얼굴 비율만으로 결정되지 않으며, '
