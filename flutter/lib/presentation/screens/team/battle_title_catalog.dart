...
const List<BattleTitleCategory> kBattleTitleCatalog = [
  BattleTitleCategory('취미', [
    BattleTitlePreset('천생연분 궁합이면 전시회 한번 같이 가요.', _kBoth),
    BattleTitlePreset('천생연분 궁합이면 영화 한편 같이 봐요.', _kBoth),
    BattleTitlePreset('천생연분 궁합이면 식사 한번 같이해요.', _kBoth),
    BattleTitlePreset('천생연분 궁합이면 커피 한잔 같이해요.', _kBoth),
    BattleTitlePreset('천생연분 궁합이면 술 한잔 같이해요.', _kBoth),
  ]),
  ...
  BattleTitleCategory('MBTI', [
    BattleTitlePreset('MBTI E끼리 모이는 자리', _kBoth),
    BattleTitlePreset('MBTI I끼리 모이는 자리', _kBoth),
    BattleTitlePreset('MBTI N끼리 모이는 자리', _kBoth),
    BattleTitlePreset('MBTI S끼리 모이는 자리', _kBoth),
    BattleTitlePreset('MBTI T끼리 모이는 자리', _kBoth),
    BattleTitlePreset('MBTI F끼리 모이는 자리', _kBoth),
    BattleTitlePreset('MBTI J끼리 모이는 자리', _kBoth),
    BattleTitlePreset('MBTI P끼리 모이는 자리', _kBoth),
  ]),
  BattleTitleCategory('직업', [
    BattleTitlePreset('대학생끼리', _kBoth),
    BattleTitlePreset('대학원생끼리', _kBoth),
    BattleTitlePreset('대기업 직장인끼리', _kBoth),
    BattleTitlePreset('좋소기업 직장인끼리', _kBoth),
    BattleTitlePreset('공무원끼리', _kBoth),
    BattleTitlePreset('자영업끼리', _kBoth),
    BattleTitlePreset('선생님끼리', _kBoth),
    BattleTitlePreset('의료인끼리', _kBoth),
    BattleTitlePreset('예술가끼리', _kBoth),
    BattleTitlePreset('전문직끼리', _kBoth),
  ]),
