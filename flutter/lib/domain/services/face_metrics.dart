...
class FaceMetrics {
  ...
  double get noseAxisTilt {
    final ax = _x(LandmarkIndex.noseTip) - _x(LandmarkIndex.nasion);
    final ay = _y(LandmarkIndex.noseTip) - _y(LandmarkIndex.nasion);
    final bx = _x(LandmarkIndex.chin) - _x(LandmarkIndex.nasion);
    final by = _y(LandmarkIndex.chin) - _y(LandmarkIndex.nasion);
