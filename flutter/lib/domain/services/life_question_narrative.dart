...
final List<_Frag> _sensualAdviceFemale = [
  _Frag(_highPair(Attribute.libido, Attribute.sensuality), [
    '풍부한 결이니 삶의 주축 중 하나로 당당히 다루세요. 미혼이라면—서두르지 말고 자기 리듬, 취향, 속도를 먼저 정확히 파악한 뒤 결이 맞는 상대를 고르는 게 장기 만족을 결정합니다. 파트너가 있다면—같은 사람과의 관계에서 매번 새로운 각도를 만드는 "창의적 재사용" 이 최고 농도를 만드는 방향입니다. 새 사람이 답이 아니라 새 장면이 답입니다.',
  ]),
  _Frag.hard(
    (f) => f.bandOf(Attribute.libido) == _Band.high &&
        f.bandOf(Attribute.sensuality) != _Band.high,
    [
      ' 타고난 욕망의 온도가 높은 편입니다. 굳이 숨기려 애쓸 필요는 없습니다. 다만, 그 에너지를 어떻게 ‘표현하느냐’가 매력의 급을 가릅니다. 미혼이라면—자기 결이 어떤 조건에서 가장 선명하게 켜지는지 관찰하는 게 곧 전략입니다. 파트너가 있다면—상대에게 먼저 원하는 것을 꺼내는 노력이 매력의 급을 가릅니다.',
    ],
  ),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.high), [
    '관능의 뿌리가 "감각의 해상도" 쪽에 있는 결입니다. 미혼이라면—새벽 2시까지 대화가 가능한 상대를 찾는 과정 자체가 관능의 설계입니다. 파트너가 있다면—미세한 변화 한 가지씩(향, 음악, 시간대) 을 매달 하나씩 넣어 주는 작은 실험이 결을 두텁게 만듭니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.mid), [
    '건강한 중용의 결입니다. 드라마 없이도 오래 갑니다—꾸준함이 장점입니다. 미혼이라면—속도의 결이 맞는 상대를 알아보는 눈을 기르세요. 파트너가 있다면—조명, 음악, 시간대를 정기적으로 살짝 바꾸는 것만으로 결이 신선하게 유지됩니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.low), [
    '규칙적이고 담담한 결입니다. 미혼이라면—몸의 신호가 유독 잘 올라오는 조건(계절, 환경 변화, 새 경험) 을 기록해 두면 자기 패턴이 보입니다. 파트너가 있다면—요리, 음악, 향 같은 감각 공부를 따로 두는 것만으로 관능의 결이 저절로 쌓이는 타입입니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.high), [
    '몸보다 마음, 감각이 먼저 움직이는 결입니다. 미혼이라면—정서적, 지적 교감이 깊은 상대와의 시간이 관능의 진짜 출발점입니다. 파트너가 있다면—상상했던 장면을 월에 한 번 실제로 옮겨 보는 작은 실행이 밀도를 확실히 키워 줍니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.mid), [
    '조건이 겹쳐야 발화하는 결입니다. 미혼이라면—긴 호흡의 상대를 찾는 게 곧 전략입니다. 짧은 시간 안에 평가되는 관계에서는 이 결이 절대 드러나지 않습니다. 파트너가 있다면—몸이 깨어나는 조건(신뢰, 공간, 반복) 을 파트너와 언어로 공유해 두세요.',
  ]),
  _Frag.hard(
    ...
    [
      '관능이 감정의 온도에 따라 결정되는 결입니다. 미혼이라면—"몸의 반응이 느리다" 가 결함이 아니라 순서가 다른 거라고 받아들이세요. 파트너가 있다면—정서적 결합이 깊어질수록 몸의 결도 같이 깊어지는 타입이라, 관계의 연륜 자체가 최대 자산입니다.',
    ],
  ),
  _Frag.hard(
    (f) => f.bandOf(Attribute.libido) == _Band.low &&
        ...
        f.bandOf(Attribute.emotionality) == _Band.low,
    [
      '관능이 전반적으로 엷게 정돈된 결이고, 이건 결함이 아니라 타고난 방향입니다. 미혼이라면—몸의 밀도 중심 관계 말고 동지적, 동료적 결합의 가능성도 진지하게 고려할 수 있습니다. 파트너가 있다면—서로의 페이스를 존중하는 게 관계의 수명을 결정합니다.',
    ],
  ),
  _Frag.hard((f) => true, [
    '관능은 삶의 부수 요소가 아니라 행복의 주요 축 중 하나입니다. 미혼이든 파트너가 있든, 자기 몸의 리듬을 솔직하게 들여다보고 건강히 즐기는 태도가 오래 결을 받쳐 줍니다. 숨기거나 억누르는 관성 대신 표현과 대화의 언어를 기르세요.',
    '이 결을 가꾸는 핵심은 셋입니다. 첫째, 자기 몸의 리듬을 정기적으로 관찰하고 기록할 것. 둘째, 미혼이라면 "결이 맞는 상대" 의 조건을 먼저 정의하고, 파트너가 있다면 작은 실험을 꾸준히 도입할 것. 셋째, 침실 문화를 숨길 것이 아니라 "가꿀 것" 으로 대하는 태도—이게 전체 결을 결정합니다.',
  ]),
  // age-stratified Advice (♀) — 30+ gated, 30~40대 vs 50대 이후 관능 변곡점.
  _Frag.hard(_isMid, [
    '30~40대 여성의 관능은 20대보다 한층 농밀해집니다. 직접적인 신호보다 분위기·태도·여운이 더 강한 매력이 됩니다. 자기 속도를 알고 있는 사람만이 그 깊이를 자기 자산으로 만듭니다.',
    '30~40대 여성은 어머니·아내·직장인이라는 사회적 역할에 묻혀 자기 몸의 리듬을 잊기 쉽습니다. 자기 시간을 잠깐이라도 떼어 두고 자기 몸의 신호를 살피는 일이 관능의 출발점입니다. 이 시기에 그걸 못하면 후반에 가서 무뎌집니다.',
    '30~40대 여성의 관능은 일과 가정 사이에서 가장 먼저 뒷순위로 밀립니다. 일주일에 한 번이라도 자기만의 감각 시간(향·음악·산책·책)을 의식적으로 만들어 두는 사람이 40대 후반에 더 풍성합니다. "바쁘다"는 핑계가 가장 큰 함정입니다.',
  ]),
  _Frag.hard(_isLate, [
    '50대 이후 여성의 매력은 외모보다 자기만의 결정·경험·내공이 만든 깊이에서 나옵니다. "처음 매력적인" 사람보다 "여전히 매력적인" 사람의 무게가 더 깊습니다. 외모가 아니라 살아온 흔적이 관능이 되는 시기입니다.',
    '50대 이후 여성의 관능은 "혼자의 시간"의 질이 좌우합니다. 자기만의 세계(책·산책·취미·친구)를 가꾼 사람일수록 동반자와의 관계도 풍성해집니다. 혼자 즐길 줄 알아야 같이도 즐겁습니다.',
    '나이가 들수록 관능은 새 사람보다 오랜 동반자와의 깊이로 표현됩니다. 함께 늙어가는 사람과의 둘만의 시간을 일부러 디자인하는 사람이 노년이 풍성합니다. 매년 새로운 작은 의례 하나가 그 깊이를 만듭니다.',
  ]),
];

final List<_Frag> _sensualAdviceMale = [
  _Frag(_highPair(Attribute.libido, Attribute.sensuality), [
    '풍부한 결이니 삶의 중심축 중 하나로 당당히 다루세요. 미혼이라면—서두르지 말고 자기 리듬, 취향, 속도를 먼저 정확히 파악한 뒤 결이 맞는 상대를 고르는 게 장기 만족을 결정합니다. 파트너가 있다면—같은 사람과의 관계에서 매번 새로운 각도를 만드는 "창의적 재사용" 이 최고 농도를 만드는 방향입니다. 새 사람이 아니라 새 장면이 답입니다.',
  ]),
  _Frag.hard(
    (f) => f.bandOf(Attribute.libido) == _Band.high &&
        f.bandOf(Attribute.sensuality) != _Band.high,
    [
      '욕구가 크고 솔직한 결입니다. 감추지 마세요—단, 표현 언어는 다듬으세요. 미혼이라면—자기 탐색과 몸의 리듬 기록이 관능의 품격을 올립니다. 파트너가 있다면—원하는 걸 상대에게 먼저 언어로 꺼내는 용기가 핵심입니다. 해석하는 부담을 상대 어깨에 올려 두지 마세요.',
    ],
  ),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.high), [
    '관능의 뿌리가 "감각의 해상도" 쪽에 있는 결입니다. 미혼이라면—새벽 2시까지 대화가 가능한 상대를 찾는 과정 자체가 관능의 설계입니다. 파트너가 있다면—미세한 변화 한 가지씩(향수 바꾸기, 플레이리스트 바꾸기, 시간대 바꾸기) 을 매달 하나씩 넣어 주는 작은 실험이 결을 두텁게 만듭니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.mid), [
    '건강한 중용의 결입니다. 드라마 없이도 오래 갑니다—꾸준함이 장점입니다. 미혼이라면—속도의 결이 맞는 상대를 알아보는 눈을 기르세요. 파트너가 있다면—조명, 음악, 시간대를 정기적으로 살짝살짝 바꾸는 것만으로 결이 신선하게 유지됩니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.low), [
    '규칙적이고 담담한 결입니다. 미혼이라면—몸의 신호가 유독 잘 올라오는 조건(계절, 환경 변화, 새 경험) 을 기록해 두면 자기 패턴이 보입니다. 파트너가 있다면—요리, 음악, 향 같은 감각 공부를 따로 두는 것만으로 관능의 결이 저절로 쌓이는 타입입니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.high), [
    '몸보다 마음, 감각이 먼저 움직이는 결입니다. 미혼이라면—정서적, 지적 교감이 깊은 상대와의 시간이 관능의 진짜 출발점입니다. 흔한 데이팅 앱 회전이 결에 안 맞는 타입입니다. 파트너가 있다면—상상했던 장면을 월에 한 번 실제로 옮겨 보는 작은 실행이 밀도를 확실히 키워 줍니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.mid), [
    '조건이 겹쳐야 발화하는 결입니다. 미혼이라면—긴 호흡의 상대를 찾는 게 곧 전략입니다. 짧은 시간 안에 평가되는 관계에서는 이 결이 절대 안 드러납니다. 파트너가 있다면—몸이 깨어나는 조건(신뢰, 공간, 반복) 을 파트너와 언어로 공유해 두세요.',
  ]),
  _Frag.hard(
    (f) => f.bandOf(Attribute.libido) == _Band.low &&
        f.bandOf(Attribute.sensuality) == _Band.low &&
        f.bandOf(Attribute.emotionality) != _Band.low,
    [
      '관능이 감정의 온도에 따라 결정되는 결입니다. 미혼이라면—"몸의 반응이 느리다" 가 결함이 아니라 그냥 순서가 다른 거라고 받아들이세요. 파트너가 있다면—정서적 결합이 깊어질수록 몸의 결도 같이 깊어지는 타입이라, 관계의 연륜 자체가 최대 자산입니다.',
    ],
  ),
  _Frag.hard(
    (f) => f.bandOf(Attribute.libido) == _Band.low &&
  ...
  // age-stratified Advice (♂) — 30+ gated, 30~40대 vs 50대 이후 관능 변곡점.
  _Frag.hard(_isMid, [
    '30~40대 남성의 관능은 외모보다 안정성·신뢰·일관성에서 나옵니다. 외부 인기보다 동반자가 인정하는 매력이 오랜 관계의 농도를 절반쯤 결정합니다. 책임을 받아들이는 모습 자체가 매력이 되는 시기입니다.',
    '30~40대 남성의 관능은 일과 가정의 압박에 가장 먼저 무뎌집니다. 직업적 성취에 매달리느라 동반자와의 시간을 미루기 쉽습니다. 주 1회 둘만의 시간을 의식적으로 잡아두는 사람이 40대 후반에도 관계가 살아 있습니다.',
    '30~40대 관능의 핵심은 같은 사람과 새로운 장면을 만들어내는 일입니다. 새 사람을 찾기보다 익숙한 상대와의 침실·여행·공동 프로젝트에 변주를 주는 사람이 더 깊이 갑니다. 익숙함을 권태로 두지 마세요.',
  ]),
  _Frag.hard(_isLate, [
    '50대 이후 남성의 관능은 외모보다 살아온 흔적에서 나옵니다. 얼굴이 곧 인생의 기록으로 읽히는 시기입니다. 자기를 잘 다듬어 온 사람의 묵직함이 가장 큰 관능 자산입니다.',
    '50대 이후 남성의 관능은 은퇴 뒤의 새 역할에서 크게 달라집니다. 직업적 정체성이 사라진 자리를 동반자와의 새 친밀함으로 채우지 못하면 관계가 빠르게 무뎌집니다. 둘만의 정기적 의례를 의식적으로 만드는 일이 핵심입니다.',
    '나이가 들수록 관능은 강도보다 느린 동행에 있습니다. 함께 마시는 커피, 같이 보는 풍경, 매년 가는 여행지 — 사소한 일상의 친밀함이 노년 관능의 진짜 자산입니다.',
  ]),
];
...
final List<_Frag> _sensualOpeningFemale = [
  ...
  _Frag(_bandPair(Attribute.libido, _Band.high, Attribute.sensuality, _Band.low), [
    '욕구는 또렷한데, 상대의 작은 흔들림을 잡는 센서가 아직 튜닝 중입니다. 한 박자 느려진 대답, 눈동자의 떨림—혼자 해석하려 애쓰지 말고 입으로 먼저 물어보세요. 그 순간 이 축도 같이 켜집니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.high), [
    '욕구의 폭은 격렬하지 않은데 감각의 해상도는 유난히 높습니다. 손끝이 한 번 스치는 그 한 뼘의 압력이 몸속에서 사방으로 번지는 구조입니다. 겉은 잔잔하고 속은 파문—관계의 깊이 자체가 관능의 축으로 작동하는 타입입니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.mid), [
    '격렬하지도 무디지도 않습니다. 계절과 감정을 따라 부드럽게 오르내리는 리듬입니다. 봄의 나른한 오후와 겨울의 조용한 저녁—서로 다른 온도가 같은 몸을 지나갑니다.',
    '평균권에 단정히 자리한 결입니다. 눈에 띄는 화려함은 없습니다. 대신 시간이 쌓일수록 은은히 깊어지는 구조—수명 긴 관계의 뿌리가 여기서 시작됩니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.low), [
    '평소엔 평범한 궤도입니다. 그런데 특정 계기—낯선 호텔 방의 창밖 불빛, 잠들기 직전 예상 못 한 한마디—가 겹치면 잠자던 밀도가 한 번에 깨어납니다. 조건부 발화형입니다. 장치 하나가 방 전체를 바꾸는 결입니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.high), [
    '몸보다 마음, 상상, 미적 감각이 먼저 움직이는 타입입니다. 관능을 체험하기보다 한 걸음 떨어져 바라보며 음미하는 쪽—사진 한 장, 영화 한 컷이 실제보다 더 깊이 남는 예술가적 결입니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.mid), [
    '평소엔 이 축이 잠들어 있습니다. 깊은 신뢰, 쌓인 시간, 새벽의 공기, 잠들기 직전의 느린 대화—조건이 겹쳐야 비로소 또렷이 열리는 결입니다. 서둘러 평가받는 관계에서는 아예 보이지 않는 구조이기도 합니다.',
  ]),
  _Frag(_lowPair(Attribute.libido, Attribute.sensuality), [
    '성적 에너지가 무대 한가운데가 아니라 조명 바깥쪽에 앉아 있는 결입니다. 결핍이 아니라 방향입니다. 정갈함, 절제, 독립이 앞섭니다—혼자만의 공간과 시간이 관계보다 먼저인 타입입니다.',
  ]),
  _Frag.hard((f) => true, [
    '어느 쪽으로도 쏠리지 않은 평이한 결입니다. 상황과 상대에 맞춰 유연히 움직이는 구조—극단 없이 삶에 자연스럽게 녹아 있는 타입입니다.',
  ]),
];
...
final List<_Frag> _sensualOpeningMale = [
  ...
  _Frag(
    ...
    [
      '욕구의 선이 굵습니다. 복잡한 전희와 긴 해석 대신, 몸이 먼저 움직이는 쪽입니다. 세밀한 감각 해상도는 평균이라 돌려 말하는 신호보다 직구가 통하는 타입입니다. 단순하지만 솔직한 결이고, 그게 오히려 상대를 안심시키는 구조입니다.',
      '드라이브 중에 갑자기 차를 세워도 이상하지 않은 타입이 있습니다. 충동이 정직하게 그 순간 올라오는 결입니다. 감각은 섬세하지 않아도 에너지가 흐리지 않아서, 원하는 걸 숨기느라 피곤해지는 일이 없습니다.',
    ],
  ),
  _Frag(
    _bandPair(Attribute.libido, _Band.high, Attribute.sensuality, _Band.low),
    [
      '엔진은 큰데 계기판은 아직 설치 중인 차 같은 구조입니다. 욕구는 확실한데, 상대가 보내는 미세 신호—숨 멈추는 타이밍, 옷깃 잡는 손의 힘 같은 것—를 놓치기 쉽습니다. 말로 직접 확인하는 습관을 들이면 계기판이 같이 켜집니다.',
    ],
  ),
  _Frag(
    _bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.high),
    [
      '욕구는 평균인데 감각의 해상도가 유난히 높습니다. 상대가 한 박자 느리게 내쉬는 숨 하나에 머릿속이 꽉 차는 타입입니다. 격렬함이 아니라 관찰의 깊이로 승부하는 결—와인잔에 맺힌 물기 하나에도 서사를 붙일 줄 아는 결입니다.',
    ],
  ),
  _Frag(
    _bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.mid),
    [
      '기복이 크지 않습니다. 극단적인 날도 없고 메마른 날도 없습니다. 계절이 바뀌듯 체온이 오르내리는 구조입니다. 눈에 띄는 화려함은 없어도, 5년 10년 같이 산 뒤에 진가가 나오는 결입니다.',
      '평균권의 단단한 결입니다. 드라마 없이 오래 가는 타입입니다. 금요일 밤보다 일요일 오후의 나른한 낮잠 같은 분위기—거기서부터 천천히 번지는 구조입니다.',
    ],
  ),
  _Frag(
    _bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.low),
    [
      '욕구도 감각도 요란하지 않습니다. 규칙적인 리듬에서 편안함을 느끼는 타입입니다. 화요일 밤 10시쯤 비슷한 시간대에 불이 들어오는 창문 같은 결입니다. 조명 하나만 바꿔도 결이 넓어지는 구조라, 작은 장치 하나가 의외로 크게 작동합니다.',
    ],
  ),
  _Frag(
    _bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.high),
    [
      '몸보다 머릿속이 먼저 뜨거워지는 타입이 있습니다. 한 편의 영화, 한 장의 사진, 한 줄의 문장에서 먼저 열리는 구조입니다. 관상학은 이걸 "마음으로 먼저 느끼는 형" 이라 부릅니다. 몸이 느려도 상상의 해상도는 남들 두 배입니다.',
    ],
  ),
  _Frag(
    _bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.mid),
    [
      '평소엔 그 축이 거의 잠들어 있습니다. 그런데 신뢰와 시간이 쌓인 특정 조건—새벽 2시, 잠들기 전의 긴 대화 같은 것—이 겹칠 때 비로소 또렷이 열립니다. 서둘러 평가받는 관계에서는 결이 안 보이는 구조입니다.',
    ],
  ),
  _Frag(
    _lowPair(Attribute.libido, Attribute.sensuality),
    [
      '성적 에너지가 삶의 무대 한가운데가 아니라 조명 바깥쪽에 서 있는 결입니다. 이건 결핍이 아니라 방향입니다. 정갈함과 독립성이 자연스럽게 앞서는 타입—혼자 있는 일요일 오전이 편안한 결입니다.',
    ],
  ),
  _Frag.hard((f) => true, [
    '뚜렷한 극단이 없습니다. 상황과 상대에 따라 유연하게 움직이는 타입입니다. 큰 기복 없이 삶에 자연스럽게 녹아 있는 결—파도라기보다 호흡에 가까운 리듬입니다.',
  ]),
];

final List<_Frag> _sensualShadowFemale = [
  _Frag(_highPair(Attribute.libido, Attribute.sensuality), [
    '결이 풍부한 만큼 에너지가 주기적으로 쌓입니다. 방치하면 수면이 얕아지고, 피부에 먼저 표시가 나고, 감정 기복이 커지는 구조입니다. 일주일에 한 번 "요즘 내 몸이 어떤 상태지" 하고 짧게 적어 두는 가벼운 습관만으로도 장기 밀도가 유지됩니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.high, Attribute.sensuality, _Band.low), [
    '욕구의 선은 굵은데 상대의 신호를 읽는 해상도가 낮으면, 엇갈리는 밤이 쌓입니다. "아까 왜 그랬지" 하고 혼자 해석하느라 피곤해지는 구조—해석 대신 "지금 뭐 원해?" 라고 직접 묻는 짧은 대화 하나가 관계의 온도차를 줄이는 가장 빠른 길입니다.',
  ]),
  _Frag(_and2(_highOf(Attribute.libido), _lowOf(Attribute.stability)), [
    '욕구는 강한데 안정성이 낮은 결은 에너지가 여러 방향으로 흩어지기 쉽습니다. 늦은 밤 감정적인 결정, 충동적 약속 같은 것들로 새 나가는 구조입니다. 수면, 식사, 운동—이 기본 세 축만 먼저 잡아 줘도 오히려 결이 더 깊어집니다.',
  ]),
  _Frag.hard(
    (f) => f.bandOf(Attribute.libido) == _Band.high &&
    ...
    [
      '외부의 시선이 들어오는 순간, 분위기가 확 달아오르는 타입이 있습니다. 누가 보고 있다는 그 묘한 긴장감, 그게 바로 감정의 불씨가 되는 구조입니다. 관상학은 이걸 꽤 직설적으로 부릅니다. "시선 의존 매력형." 쉽게 말하면 이런 겁니다. 무대 위에서는 누구보다 뜨겁고 매혹적인데, 조명이 꺼지고 관객이 빠지면 온도가 같이 내려가는 타입입니다. 혼자 있는 시간에 조용히 켜지는 자기만의 리듬을 따로 만들어 두면, 관객이 없어도 뜨거울 수 있는 결로 넘어갑니다.',
    ],
  ),
  _Frag(_highPair(Attribute.libido, Attribute.stability), [
    '욕구는 강한데 안정성이 매우 높은 결은 에너지가 지나치게 눌려 있는 경우가 많습니다. 겉으로는 단단한데 안에서는 압력이 올라가는 구조—운동, 취미, 파트너와의 솔직한 대화 중 하나라도 출구로 두면 그 압력이 수면과 피부, 감정으로 옮겨가지 않습니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.high), [
    '머릿속의 그림은 선명한데, 몸이 그걸 따라가지 않는 결입니다. 상상과 실행의 간격이 오래 따라붙는 타입—이 간격을 억지로 없앨 필요는 없습니다. 한 달에 한 번 정도, 상상했던 조건 하나를 실제 공간으로 옮겨 보는 것만으로 결이 끊기지 않습니다.',
  ]),
  _Frag.hard(
    (f) => f.bandOf(Attribute.libido) == _Band.low &&
        f.bandOf(Attribute.sensuality) == _Band.low &&
        f.bandOf(Attribute.emotionality) == _Band.low,
    [
      '관능 전반이 엷은 결은 관계가 어느 순간 "생활의 편의" 쪽으로만 수렴되기 쉽습니다. 같이 밥 먹고, 청소하고, 일정 공유하고—이것만 남는 구조입니다. 몸의 자극이 아니라 같이 발견한 취향, 같이 웃은 장면으로 결을 깨우는 연습이 관계의 안정감을 더해 줍니다.',
    ],
  ),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.low), [
    '중간과 엷은 결이 섞이면 관계 리듬이 어느새 의례화됩니다. 금요일은 원래 이런 식, 일요일은 원래 이런 식—자동 재생되는 구조입니다. 조명 하나, 시간대 하나, 공간 하나만 주기적으로 바꿔도 결이 다시 살아납니다.',
  ]),
  _Frag(_highPair(Attribute.sensuality, Attribute.emotionality), [
    '감정의 진폭이 관능의 방향을 크게 흔드는 결입니다. 마음이 허전한 밤에 그게 엉뚱한 곳으로 흐르기 쉬운 구조—그래서 파트너 (또는 혼자라면 자기 자신) 와 감정을 점검하는 대화 루틴이 안전판이 됩니다.',
  ]),
  _Frag.hard((f) => f.fired('O-PH1') || f.fired('O-PH2'), [
    '인중 쪽 결이 유독 두드러졌습니다. 호르몬 리듬이 얼굴과 관능 표현에 그대로 반영되는 구조—수면, 영양의 기본 축을 지키면 밀도가 저절로 유지됩니다. 생리 주기와 컨디션의 상관을 기록해 두면 자기 패턴이 보이는 타입입니다.',
  ]),
  _Frag(_lowOf(Attribute.libido), [
    '이 축이 엷은 결은 "남들만큼 뜨거워야 한다" 는 기준에서 먼저 자유로워져야 합니다. 자기 결을 결함으로 읽지 말고 방향으로 받아들이는 태도가 관계의 자율성을 지키는 핵심입니다.',
  ]),
  _Frag.hard((f) => true, [
    '관능의 결은 긴 시간 속에서 소리 없이 얇아집니다. 갑자기가 아니라, 한 달이 두 달 되고 반년 되면서 스며들듯 옅어지는 구조입니다. 계절 바뀔 때마다 한 번씩 자기 몸의 신호를 점검하는 짧은 루틴이 오래 밀도를 받쳐 줍니다.',
    '관능의 리듬은 업무, 수면, 계절, 생리 주기 같은 외부 요인에 생각보다 크게 흔들립니다. 마감 주간에 관심이 뚝 떨어지는 건 결함이 아니라 당연한 반응입니다. 자기 상태를 정기적으로 읽고 기록하는 습관이 관계의 온도를 흔들리지 않게 받쳐 줍니다.',
  ]),
];

final List<_Frag> _sensualShadowMale = [
  _Frag(_highPair(Attribute.libido, Attribute.sensuality), [
    '엔진 크기가 큰 만큼 에너지가 주기적으로 쌓입니다. 방치하면 수면이 얕아지고 집중이 흐려지는 구조입니다. 거창한 관리 말고, 일주일에 한 번 "요즘 몸이 어떤 상태더라" 하고 적어 보는 가벼운 습관만으로도 장기 밀도가 유지됩니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.high, Attribute.sensuality, _Band.low), [
    '욕구는 굵은데 상대의 신호를 읽는 해상도가 낮으면 자주 엇갈립니다. 왜 상대가 갑자기 조용해졌는지 모르는 채 넘어가는 밤이 쌓인다는 뜻입니다. 해석 대신 "뭐 원해?" 짧게 묻는 습관 하나가 관계의 온도차를 줄이는 가장 빠른 길입니다.',
  ]),
  _Frag(_and2(_highOf(Attribute.libido), _lowOf(Attribute.stability)), [
    '욕구는 강한데 안정성이 낮은 결은 에너지가 여기저기로 흩어지기 쉽습니다. 새벽 2시 문자, 충동적인 약속 같은 걸로 새 나가는 구조입니다. 수면, 식사, 운동 이 기본 축 세 개만 잡아 줘도 오히려 관능의 밀도가 깊어집니다.',
  ]),
  _Frag.hard(
    (f) => f.bandOf(Attribute.libido) == _Band.high &&
        f.bandOf(Attribute.attractiveness) == _Band.high &&
        f.bandOf(Attribute.stability) == _Band.low,
    [
      '외부의 시선이 들어오는 순간, 분위기가 확 달아오르는 타입이 있습니다. 누가 보고 있다는 묘한 긴장감, 그게 감정의 불씨가 되는 구조입니다. 관상학은 이걸 꽤 직설적으로 부릅니다. "시선 의존 매력형." 쉽게 말하면 이런 겁니다. 무대 위에서는 누구보다 뜨거운데, 조명이 꺼지고 관객이 빠지면 온도가 같이 내려가는 타입입니다. 혼자 있을 때 조용히 켜지는 리듬을 따로 만들어 두면, 관객이 없어도 뜨거워질 수 있는 결로 옮겨 갑니다.',
    ],
  ),
  _Frag(_highPair(Attribute.libido, Attribute.stability), [
    '욕구는 강한데 안정성이 매우 높은 결은 에너지가 과도하게 눌려 있는 경우가 많습니다. 겉으로는 단단한데 안에서는 압력이 올라가는 구조입니다. 운동, 취미, 파트너와의 솔직한 대화—이 셋 중 하나라도 출구로 두면 그 압력이 수면이나 감정으로 새지 않습니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.high), [
    '머릿속에서는 선명한데 몸이 따라가지 않는 결입니다. 상상과 실행의 간격이 오래 따라붙는 타입—이 간격을 제로로 만들 필요는 없습니다. 한 달에 한 번만, 상상했던 조건 중 하나를 실제 공간으로 옮겨 봐도 결이 끊기지 않습니다.',
  ]),
  _Frag.hard(
    (f) => f.bandOf(Attribute.libido) == _Band.low &&
        f.bandOf(Attribute.sensuality) == _Band.low &&
        f.bandOf(Attribute.emotionality) == _Band.low,
    [
      '관능이 전반적으로 엷은 결은 관계가 점점 "생활의 편의" 쪽으로만 수렴되기 쉽습니다. 식사, 청소, 일정—이것만 공유되는 동거 같은 결입니다. 몸의 자극이 아니라 같이 발견한 취향, 같이 웃은 장면으로 결을 깨우는 연습이 관계의 안정감을 더해 줍니다.',
    ],
  ),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.low), [
    '중간과 엷은 결이 섞이면 관계가 슬그머니 의례화됩니다. 금요일 밤은 원래 이런 식, 일요일 아침은 원래 이런 식—이런 고정 패턴이 자동으로 돌아갑니다. 조명 하나, 시간대 하나, 장소 하나만 주기적으로 바꿔 줘도 결이 다시 살아납니다.',
  ]),
  _Frag(_highPair(Attribute.sensuality, Attribute.emotionality), [
    '감정의 진폭이 관능의 방향을 크게 흔드는 결입니다. 마음이 허전한 밤에 그게 엉뚱한 곳으로 흘러가기 쉬운 구조—그래서 파트너 (또는 혼자라면 자기 자신) 와 감정을 점검하는 짧은 대화 루틴이 방파제가 됩니다.',
  ]),
  _Frag.hard((f) => f.fired('O-PH1') || f.fired('O-PH2'), [
    '인중 쪽 결이 유독 두드러진 구조입니다. 이건 호르몬 리듬이 얼굴과 관능 표현에 그대로 반영된다는 뜻—수면 부족하면 얼굴부터 표시가 나는 타입입니다. 잠과 영양, 이 기본만 지켜도 밀도가 알아서 유지됩니다.',
  ]),
  _Frag.hard((f) => true, [
    '관능의 결은 긴 시간 속에서 소리 없이 얇아집니다. 어느 날 갑자기가 아니라, 한 달이 두 달 되고 반년 되면서 스며들듯 옅어지는 구조입니다. 계절 바뀔 때마다 한 번씩 자기 몸의 신호를 점검하는 짧은 루틴이 오래 밀도를 받쳐 줍니다.',
    '관능의 리듬은 업무, 수면, 계절 같은 외부 요인에 생각보다 크게 흔들립니다. 마감 주간에 관심이 뚝 떨어지는 게 이상한 게 아니라는 뜻입니다. 자기 상태를 정기적으로 읽고 기록하는 습관이 관계의 온도를 흔들리지 않게 받쳐 줍니다.',
  ]),
];

final List<_Frag> _sensualStrengthFemale = [
  _Frag(_metHi('mouthCornerAngle'), [
    '입꼬리가 확 올라가 있습니다. 기본 표정이 이미 살짝 웃고 있는 상태—침실에서도 웃음이 배경음처럼 깔리는 타입입니다. 긴장이 즐거움으로 번역되는 결이라, 상대가 당신 옆에서 숨을 길게 내쉬게 됩니다.',
    '올라간 입꼬리는 관능이 밝은 에너지와 한 세트로 묶여 있다는 신호입니다. 공기 자체를 환하게 만드는 결—심각해지려는 순간에 먼저 작게 웃어 버리는 구조입니다. 그게 이 결의 지속력을 받쳐 줍니다.',
  ]),
  _Frag(_metMid('mouthCornerAngle'), [
    '입꼬리가 수평에 가깝습니다. 온도가 쉽게 드러나지 않는 타입이라 처음 만났을 때는 차분해 보이는 편입니다. 그런데 진짜 안쪽으로 들어온 상대에게는 기대 이상의 농도가 풀려 나오는 이중 구조입니다.',
  ]),
  _Frag(_metLo('mouthCornerAngle'), [
    '입꼬리가 살짝 내려간 결입니다. 평소 분위기가 진지한 쪽이라 가볍게 풀리는 순간이 흔치 않습니다. 그래서 오히려 한마디, 한 몸짓의 무게가 커지는 타입—그 무게 자체가 상대의 집중감이 됩니다.',
  ]),
  _Frag(_metHi('lipFullnessRatio'), [
    '입술이 도톰합니다. 마음 이 얼굴에서 먼저 읽히는 결—말보다 표정이 먼저 닿습니다. 식복과 언복까지 같이 열려 있어서, 공간 자체를 부드럽게 만드는 강점이 있습니다. 와인잔 건너로 시선이 오래 머무는 결입니다.',
    '도톰한 입술은 감각이 살아 있다는 증거입니다. 미식, 향, 음악처럼 섬세한 즐거움이 관능과 자연스럽게 한 세트로 섞이는 타입—상대에게 풍요로운 공기를 전하는 구조입니다.',
  ]),
  _Frag(_metMid('lipFullnessRatio'), [
    '입술 두께가 평균권입니다. 감성과 절제가 반씩 섞인 결이라 표현이 한쪽으로 쏠리지 않습니다. 상대의 결에 맞춰 모드를 조용히 조율하는 타입—과잉도 결핍도 없습니다.',
  ]),
  _Frag(_metLo('lipFullnessRatio'), [
    '입술이 얇습니다. 이성과 절제의 기질이 감정보다 반 박자 앞서는 결이라 표현이 담담한 형태로 나갑니다. 대신 한 번의 표현이 선명해서 상대에게는 오히려 깊이로 각인되는 구조입니다.',
  ]),
  _Frag(_metHi('upperVsLowerLipRatio'), [
    '윗입술이 아랫입술보다 두껍습니다. 주는 쪽에서 충족감을 얻는 결이라, 관능의 방향이 "받기" 보다 "배려하기" 쪽으로 기울어 있습니다. 공동의 만족에서 자기 만족이 완성되는 타입입니다.',
  ]),
  _Frag(_metLo('upperVsLowerLipRatio'), [
    '아랫입술이 더 두껍습니다. 오감—특히 질감과 온도—에 민감한 타입이라 감각적 향유가 유난히 발달해 있습니다. 조명, 음악, 향수 하나만 바뀌어도 몸이 반응하는 결입니다.',
  ]),
  _Frag(_metHi('philtrumLength'), [
    '인중이 깁니다. 관상학은 이 결을 "오래가는 형" 이라 부릅니다. 쉽게 말하면, 짧은 폭발보다 긴 밀도로 승부하는 구조—같이 보낸 시간이 쌓일수록 오히려 몸의 감각이 더 깊어지는 드문 결입니다.',
  ]),
  _Frag(_metMid('philtrumLength'), [
    '인중 길이가 평균권입니다. 욕구의 리듬이 자연스럽게 오르락내리락하는 안정형—몸의 신호를 따라 유연하게 움직이는 구조입니다.',
  ]),
  _Frag(_metLo('philtrumLength'), [
    '인중이 짧습니다. 피크는 뚜렷한데 지속 구간이 짧은 단발형 결—짧은 시간 안에 농도를 압축해서 씁니다. 쌓는 시간과 쏟는 시간을 의식적으로 분리해 두면 이 리듬이 더 길게 이어집니다.',
  ]),
  _Frag(_metHi('eyeCanthalTilt'), [
    '눈꼬리가 위로 올라가 있습니다. 집중력과 기세가 눈에서 먼저 드러나는 결이라 관능이 적극적이고 주도적인 쪽으로 움직입니다. 시선만으로 신호를 보내는 강점이 있는 타입입니다.',
  ]),
  _Frag(_metLo('eyeCanthalTilt'), [
    '눈꼬리가 부드럽게 내려간 결입니다. 온화함이 눈에서 먼저 전해져서 상대가 어깨의 힘을 저절로 풀게 되는 구조입니다. 관능이 끌어안는 쪽으로 움직이는 포용형 타입입니다.',
  ]),
  _Frag(_metHi('eyeAspect'), [
    '눈이 둥글고 크게 열려 있습니다. 호기심과 활력이 눈에서 그대로 넘치는 타입—감정 표현이 솔직하고 풍부해서 상대가 결을 읽기 쉬운 결입니다.',
  ]),
  _Frag(_metLo('eyeAspect'), [
    '눈이 가늘고 깁니다. 관찰력과 심미안이 눈에 깊이 박혀 있어서, 말 없이 눈빛만으로 신호가 전달되는 타입입니다. 상대에게는 그 절제된 신호가 오히려 숨을 멈추게 하는 긴장감이 됩니다.',
  ]),
  _Frag(_metHi('eyebrowThickness'), [
    '눈썹이 짙고 또렷합니다. 활력의 축이 얼굴에 건강히 섞여 있는 결—몸의 컨디션과 욕구 리듬이 함께 움직이는 구조입니다. 수면과 체력이 관능의 결을 직접 조율하는 타입입니다.',
  ]),
  _Frag(_metLo('eyebrowThickness'), [
    '눈썹이 얇고 담담합니다. 크게 요동치지 않는 기질이 얼굴에 새겨진 결이라, 관능 역시 과하지 않은 안정권에 머뭅니다. 평화와 독립이 먼저라, 관계 안에서 편안한 공기를 만드는 타입입니다.',
  ]),
  _Frag(_metHi('eyebrowCurvature'), [
    '눈썹이 또렷한 아치형입니다. 감수성과 예술 기질이 살아 있는 결—같은 상대와도 매번 다른 밤을 만들어 내는 창의형 구조입니다. 어제와 오늘의 공기가 다르게 조합되는 타입입니다.',
  ]),
  _Frag(_metLo('eyebrowCurvature'), [
    '눈썹이 직선에 가깝습니다. 논리와 실용의 기질이 얼굴에 박혀 있어 리듬이 안정적이고 예측 가능합니다. 이게 지루함이 아니라 신뢰의 기반이 되는 결입니다.',
  ]),
  _Frag(_metHi('cheekboneWidth'), [
    '광대가 또렷이 자리했습니다. 체력의 축이 골격에 박힌 결이라 이 결의 지속력이 깁니다. 짧은 집중이 아니라 긴 밀도를 내는 몸의 뿌리가 여기 있습니다—관계의 후반으로 갈수록 결이 더 깊어지는 구조입니다.',
  ]),
  _Frag(_metLo('cheekboneWidth'), [
    '광대가 낮고 부드럽게 자리합니다. 호령보다 조율이 먼저 얼굴에 읽히는 결이라, 표현이 섬세한 대화와 교감 쪽에 가깝습니다—베개 위의 긴 이야기가 더 어울리는 타입입니다.',
  ]),
  _Frag(_metHi('nasolabialAngle'), [
    '코끝이 살짝 위로 들렸습니다. 개방적이고 낙천적인 기질이 자리 잡아서 표현이 가볍고 에너지가 넘칩니다. 새로운 장소, 새로운 시간대를 두려워하지 않는 탐험형 결입니다.',
  ]),
  _Frag(_metLo('nasolabialAngle'), [
    '코끝이 아래로 처졌습니다. 보수적이고 안정 지향의 기질이 깔린 타입이라, 관능이 신뢰 쌓인 관계 안에서만 또렷이 열리는 깊이형 구조입니다.',
  ]),
  _Frag(_metHi('gonialAngle'), [
    '턱이 뚜렷한 각을 이뤘습니다. 의지와 끈기의 축이 하정에 새겨진 결이라 지속력이 강합니다. 한 번 들어간 리듬을 끝까지 끌고 가는 체력형 구조—쉽게 흐트러지지 않는 타입입니다.',
  ]),
  _Frag(_metLo('gonialAngle'), [
    '턱이 둥글게 자리했습니다. 부드러움과 친화가 하정에 자리한 결이라 표현이 격렬함보다 따뜻함, 포근함 쪽으로 기웁니다—이불 속의 편안한 온도 같은 결입니다.',
  ]),
  _Frag(_metHi('faceAspectRatio'), [
    '얼굴이 세로로 깁니다. 사색과 몰입의 기운이 전체에 박혀 있어서, 관능이 깊이와 집중 쪽으로 흐릅니다. 한 사람에게만 통째로 쏠리는 몰입감—상대가 유일하게 느껴지는 결입니다.',
  ]),
  _Frag(_metLo('faceAspectRatio'), [
    '얼굴이 가로로 넓습니다. 활력과 포용의 에너지가 자리 잡은 결이라 표현이 활달하고 개방적입니다. 같이 있으면 공기가 환해지는 타입—주말 모임의 중심에 자연스럽게 놓이는 결입니다.',
  ]),
  _Frag.hard((f) => f.fired('L-EL'), [
    '옆에서 보면 입술이 E-line 을 넘어 나와 있습니다. 관능이 입매에서 먼저 드러나는 해부학적 구조—말하는 동안 상대 시선이 입에 머뭅니다. 이야기 내용보다 입 모양이 먼저 기억되는 결입니다.',
  ]),
  _Frag.hard(_yangStrong, [
    '여성의 얼굴에 양 의 기운이 뚜렷이 쏠린 결은 드문 타입입니다. 관능의 리듬이 적극적이고 주도적인 쪽으로 자연스럽게 기웁니다—"먼저 움직이는 쪽" 을 당당하게 활용할 때 가장 선명한 매력이 드러나는 구조입니다.',
  ]),
  _Frag.hard(_yinStrong, [
    '얼굴 전체에 음 의 기운이 짙게 쏠려 있습니다. 수용과 포용의 축이 관능의 뼈대가 되는 타입—상대를 끌어안는 결 자체에서 농도가 피어납니다. 시간이 깊어질수록 결이 더 또렷해지는 구조입니다.',
  ]),
  _Frag.hard(_yyHarmony, [
    '얼굴에 음양이 고르게 자리했습니다. 표현이 주도와 수용 사이를 자유롭게 오가는 유연형—파트너의 결에 맞춰 모드를 바꾸는 적응력이 최대 강점입니다.',
  ]),
  _Frag.hard((f) => f.fired('O-PH1') || f.fired('O-PH2'), [
...
final List<_Frag> _sensualStrengthMale = [
  _Frag(_metHi('mouthCornerAngle'), [
    '웃을 때 입꼬리가 위로 확 올라갑니다. 기본 표정 자체가 살짝 웃는 상태라 침실에서도 웃음이 배경음으로 깔리는 타입—심각해질 순간에 자기도 모르게 긴장을 풀어내는 결입니다. 관계의 무게를 스스로 덜어낼 줄 아는 사람입니다.',
    '올라간 입꼬리는 긴장을 친화감으로 바꾸는 장치입니다. 상대가 당신 옆에 있으면 어깨에 들어가 있던 힘이 자연스럽게 빠집니다. 그 공기 자체가 관능의 지속력을 받치는 구조입니다.',
  ]),
  _Frag(_metMid('mouthCornerAngle'), [
    '입꼬리가 수평에 가깝습니다. 처음엔 뭘 생각하는지 잘 안 읽히는 타입—첫인상은 차갑기까지 합니다. 그런데 안쪽까지 들어온 사람에게는 기대치를 훌쩍 넘는 농도가 나오는 이중 구조입니다.',
  ]),
  _Frag(_metLo('mouthCornerAngle'), [
    '입꼬리가 살짝 내려간 결입니다. 가볍게 풀리는 순간이 드물고 기본 분위기가 진지합니다. 그래서 오히려 한마디, 한 손짓의 무게가 커집니다. 파트너에게는 그 무게 자체가 빠져나갈 수 없는 집중감이 됩니다.',
  ]),
  _Frag(_metHi('lipFullnessRatio'), [
    '입술이 도톰합니다. 마음 이라는 게 얼굴에서 먼저 읽히는 타입—말보다 표정이 먼저 닿습니다. 같이 밥 먹으러 간 식당의 공기까지 부드럽게 만드는 결입니다. 와인 한 잔만 있어도 분위기가 바뀝니다.',
    '도톰한 입술은 감각이 살아 있다는 증거입니다. 미식, 향, 음악 같은 섬세한 즐거움이 관능과 자연스럽게 한 세트로 묶이는 타입입니다. 상대에게 풍요로운 공기를 밀어 보내는 구조입니다.',
  ]),
  _Frag(_metMid('lipFullnessRatio'), [
    '입술 두께가 평균입니다. 감성과 절제가 반반씩 섞인 결이라 어느 한쪽으로 쏠리지 않습니다. 상대의 결에 맞춰 모드를 조용히 조절하는 타입—과하지도, 모자라지도 않습니다.',
  ]),
  _Frag(_metLo('lipFullnessRatio'), [
    '입술이 얇습니다. 이성이 감정보다 반 박자 앞서는 결입니다. 표현이 담담하게 나오는 대신, 그 한 번이 선명해서 오히려 오래 각인됩니다. 아껴 쓰는 사람의 한마디가 더 깊이 박히는 것과 같은 구조입니다.',
  ]),
  _Frag(_metHi('upperVsLowerLipRatio'), [
    '윗입술이 아랫입술보다 두껍습니다. 주는 쪽에서 충족감을 얻는 결—받는 것보다 배려하는 쪽이 자연스러운 타입입니다. 침실의 기쁨이 "내가 좋았다" 보다 "둘 다 좋았다" 에서 완성되는 구조입니다.',
  ]),
  _Frag(_metLo('upperVsLowerLipRatio'), [
    '아랫입술이 더 두껍습니다. 오감, 특히 질감과 온도에 민감한 타입—실크 셔츠의 감촉, 새벽 공기의 온도, 이런 디테일이 바로 몸에 등록됩니다. 조명 하나, 향수 하나가 공간 전체를 바꿔 놓는 결입니다.',
  ]),
  _Frag(_metHi('philtrumLength'), [
    '인중이 깁니다. 관상학은 이걸 "오래가는 형" 이라 부릅니다. 쉽게 말하면 이런 겁니다. 짧게 폭발하는 게 아니라 긴 시간 밀도로 승부하는 구조입니다. 같이 산 세월이 쌓일수록 오히려 몸의 감각이 더 깊어지는, 드문 결입니다.',
  ]),
  _Frag(_metMid('philtrumLength'), [
    '인중 길이가 평균입니다. 욕구의 리듬이 자연스럽게 오르락내리락하는 안정형입니다. 오늘은 이만큼, 내일은 저만큼—몸의 신호를 따라 유연하게 움직이는 타입입니다.',
  ]),
  _Frag(_metLo('philtrumLength'), [
    '인중이 짧습니다. 피크는 뚜렷한데 지속 구간이 짧은 단발형 결—짧은 시간 안에 농도를 압축해서 씁니다. 쌓는 시간과 쏟는 시간을 의식적으로 분리해 두면 리듬이 길어집니다.',
  ]),
  _Frag(_metHi('eyeCanthalTilt'), [
    '눈꼬리가 위로 올라갔습니다. 집중력과 기세가 눈에서 먼저 새어 나오는 결—쳐다보면 상대가 먼저 시선을 피합니다. 관능이 쫓는 쪽으로 움직이는 타입이고, 말없이 눈만으로 신호를 보내는 강점이 있습니다.',
  ]),
  _Frag(_metLo('eyeCanthalTilt'), [
    '눈꼬리가 부드럽게 내려간 결입니다. 바라보고만 있어도 상대 어깨가 내려가는 구조—온화함이 먼저 닿습니다. 관능이 몰아붙이는 쪽이 아니라 끌어안는 쪽으로 움직이는 포용형입니다.',
  ]),
  _Frag(_metHi('eyeAspect'), [
    '눈이 둥글고 크게 열려 있습니다. 호기심과 활력이 눈에서 먼저 튀어나오는 타입—감정이 눈빛에 그대로 실립니다. 표현이 솔직해서 상대가 당신 기분을 추측할 필요가 없는 결입니다.',
  ]),
  _Frag(_metLo('eyeAspect'), [
    '눈이 가늘고 깁니다. 관찰력과 심미안이 눈에 박혀 있어서, 말 대신 눈빛이 먼저 가는 타입입니다. 상대에게는 그 절제된 신호가 오히려 숨 멈추는 긴장감이 됩니다—조명 꺼진 엘리베이터 안의 정적 같은 결입니다.',
  ]),
  _Frag(_metHi('eyebrowThickness'), [
    '눈썹이 짙고 두껍습니다. 의지와 결단의 기운이 얼굴에서 먼저 읽히는 결이라, 관능의 리듬에도 끈기의 축이 섞여 있습니다. 한 번 맞춘 호흡을 끝까지 끌고 가는 체력형 타입입니다.',
  ]),
  _Frag(_metLo('eyebrowThickness'), [
    '눈썹이 얇고 담담합니다. 크게 요동치지 않는 기질이 얼굴에 새겨져 있어서, 관능 역시 격렬하지 않은 안정권에 머뭅니다. 상대에게는 편안한 공기—가을 일요일 오후 같은 결로 읽힙니다.',
  ]),
  _Frag(_metHi('eyebrowCurvature'), [
    '눈썹이 또렷한 아치형입니다. 감수성과 예술 기질이 살아 있는 결—같은 상대와도 매번 다른 밤을 만들어 내는 창의형 구조입니다. 어제와 오늘의 공기가 다르게 조합되는 타입입니다.',
  ]),
  _Frag(_metLo('eyebrowCurvature'), [
    '눈썹이 직선에 가깝습니다. 논리와 실용이 얼굴에 박혀 있는 결이라 리듬이 안정적이고 예측 가능합니다. 이게 지루함이 아니라 신뢰의 기반으로 작동하는 타입—상대가 먼저 안심하는 구조입니다.',
  ]),
  _Frag(_metHi('cheekboneWidth'), [
    '광대가 단단히 솟아 있습니다. 체력의 축이 골격에 박힌 결이라 관능의 지속력이 깁니다. 짧은 집중이 아니라 긴 밀도를 내는 몸의 뿌리가 여기 있습니다—관계의 후반에 갈수록 오히려 결이 깊어지는 구조입니다.',
  ]),
  _Frag(_metLo('cheekboneWidth'), [
    '광대가 낮고 부드럽게 자리합니다. 호령보다 조율이 먼저 얼굴에 읽히는 타입이라, 관능의 표현이 대화와 교감 쪽에 더 기웁니다. 베개에 나란히 누워 30분씩 이야기하는 게 더 자연스러운 결입니다.',
  ]),
  _Frag(_metHi('nasolabialAngle'), [
    '코끝이 살짝 위로 들렸습니다. 개방적이고 낙천적인 기질이 얼굴에 자리 잡아서, 관능의 표현이 가볍고 에너지가 넘칩니다. 새로운 장소, 새로운 시간대에 거리낌이 적은 탐험형 결입니다.',
  ]),
  _Frag(_metLo('nasolabialAngle'), [
    '코끝이 아래로 처졌습니다. 보수적이고 안정 지향의 기질이 깔린 타입이라, 관능이 신뢰 쌓인 관계 안에서만 또렷이 열립니다. 아무하고나 열리지 않는 깊이형 구조입니다.',
  ]),
  _Frag(_metHi('gonialAngle'), [
    '턱이 각지게 자리했습니다. 의지와 끈기의 축이 하정에 새겨져 있어서 지속력이 강합니다. 한 번 들어간 리듬을 끝까지 끌고 가는 체력형—새벽까지 흐트러지지 않는 구조입니다.',
  ]),
  _Frag(_metLo('gonialAngle'), [
    '턱이 둥글게 자리했습니다. 부드러움과 친화가 하정에 자리한 결이라, 관능의 표현이 격렬함보다 따뜻함 쪽으로 기웁니다. 이불 안의 포근한 온도 같은 결입니다.',
  ]),
  _Frag(_metHi('faceAspectRatio'), [
    '얼굴이 세로로 깁니다. 사색과 몰입의 기운이 전체에 박혀 있어서, 관능이 깊이와 집중 쪽으로 흐릅니다. 한 사람에게 통째로 쏠리는 몰입감—상대가 유일하게 느껴지는 결입니다.',
  ]),
  _Frag(_metLo('faceAspectRatio'), [
    '얼굴이 가로로 넓습니다. 활력과 포용의 에너지가 자리 잡은 결이라 표현이 활달하고 개방적입니다. 같이 있으면 공기가 환해지는 타입—주말 브런치 자리의 분위기 메이커 같은 결입니다.',
  ]),
  _Frag.hard((f) => f.fired('L-EL'), [
    '옆에서 보면 입술이 E-line 을 넘어 나와 있습니다. 관능이 입매에서 먼저 드러나는 해부학적 구조—말할 때마다 상대 시선이 입에 머뭅니다. 이야기 내용보다 입 모양이 먼저 기억되는 결입니다.',
  ]),
  _Frag.hard(_yangStrong, [
    '얼굴 전체에 양의 기운이 짙게 서렸습니다. 관능의 리듬이 적극적이고 주도적인 쪽으로 기울어 있는 결—"먼저 움직이는 쪽" 이 자연스럽습니다. 상대가 그걸 기다리는 구조이기도 합니다.',
  ]),
  _Frag.hard(_yinStrong, [
    '얼굴에 음의 기운이 깊이 깃들어 있습니다. 관능이 수용과 포용 쪽으로 기울어 있어서, 격렬한 파도보다 잔잔한 깊이로 관계를 만듭니다. 조명 꺼진 방의 부드러운 정적 같은 결입니다.',
  ]),
  _Frag.hard(_yyHarmony, [
...
/// 절반 이상의 문장이 "관상" 으로 시작하면 그 단어만 남는다. 리포트 전체가
/// 관상 이야기라 문맥이 이미 말해 주므로, 대부분은 "관상" 없이 쓴다.
/// 분야·책을 분명히 해야 하는 자리에만 남긴다.
///
/// 순서가 곧 대체 우선순위다 — 앞쪽일수록 먼저 골라 쓴다.
