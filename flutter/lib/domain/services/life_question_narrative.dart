...
final List<_Frag> _healthAdvice = [
  ...
  _Frag.hard(_isMid, [
    '30~40대 정점기의 건강 변곡점—35~45세 사이에 몸의 누적이 처음으로 표면화되는 구간입니다. 20대에 쌓인 습관이 청구서로 돌아오는 시기—지금 정기 검진 주기를 1년으로 잡고, 가장 약한 한 가지 축(수면·식사·운동)을 우선 표준화하십시오. @{palace_health}의 결을 보호하는 가장 큰 방어선은 이 시기의 검진 누락 여부입니다.',
    ...
    '30~40대 정점기의건강은 "감정의 누적"이 신체로 옮겨가는 통로를 인식하는 데서 시작됩니다. 30~40대는 일과 가족 양쪽의 책임이 동시에 집중되는 구간이라, 해소되지 않은 스트레스가 특정 장기·관절·수면으로 직접 가는 패턴이 굳어지기 쉽습니다. 명상·상담·정기 운동 중 하나를 감정 배수로로 못 박아 두는 것이 결정적입니다.',
  ]),
  _Frag.hard(_isLate, [
...
final List<_Frag> _romanceAdviceFemale = [
  ...
  _Frag.hard(_isMid, [
    ...
    '관상학이 "중년 부부 시기"이라 부르는 구간은 단순한 사랑보다 동행 능력을 본다고 일러줍니다. 지금의 인연은 "5년 뒤 같이 살 수 있는가"가 가장 정직한 기준—말의 화려함보다 일상의 사소한 합의가 잘 되는 사람을 알아보는 눈이 가장 큰 자산입니다.',
  ...
  _Frag.hard(_isLate, [
    ...
    '관상학이 "후복의 부부궁"이라 부르는 구간—후반의 결이 노년 동반자 관계의 안정성을 약속합니다. 다만 "관계의 새 페이지"를 함께 펴는 작업이 의식적이지 않으면 침묵의 누적으로 결이 흐려지는 시기—매년 둘만의 의례를 새로 하나씩 만드는 습관이 후복을 두텁게 합니다.',
...
final List<_Frag> _romanceAdviceMale = [
  ...
  _Frag.hard(_isMid, [
    ...
    '중년 부부 시기의 발복은 남성에게 "결단의 시기"로 다가옵니다. 평생 동반자에 대한 책임을 받아들일 준비—이 결단을 미루는 시기가 길어질수록 30~40대 정점기의결이 흐려지는 패턴이 따라옵니다. 30대 후반의 결정이 평생 가정·자녀·후복 곡선을 좌우합니다.',
  ...
  _Frag.hard(_isLate, [
    ...
    '관상학이 "후복"의 결이라 부르는 시기—후반의 묵직함이 동반자에게 안정감을 주는 자산입니다. 이 시기의 관계 재정비—함께 늙어갈 공통의 리듬, 함께 가질 취미, 함께 갈 여행—이 노년 행복의 80%를 결정합니다. 자식이 떠난 뒤 둘이 남는 시간을 적극적으로 설계하지 않으면 침묵으로 흐립니다.',
...
final List<_Frag> _sensualAdviceFemale = [
  ...
  _Frag.hard(_isMid, [
    ...
    '30~40대 정점기의여성 관능은 일과 가정의 압박 사이에서 가장 쉽게 후순위로 밀린다. "관능의 우선순위 보호" 가 30~40대 정점기의 숨은 핵심—주 1회라도 자기만의 감각 시간(향, 음악, 산책, 책)을 의식적으로 확보하는 사람만이 40대 후반의 결을 가꾼다.',
  ]),
  _Frag.hard(_isLate, [
    '50대 이후 여성의 관능은 "존재감" 의 결이다. 50대 이후 여성의 매력은 외형보다 자신만의 결정, 경험, 내공이 만든 깊이—"아직도 매력적인" 의 무게가 "처음 매력적인" 보다 깊다. @{palace_spouse}의 결이 후복 의 형태로 다시 활성화되는 시기이다.',
    '50대 이후의 여성 관능은 "혼자의 시간" 의 질이 결정한다. 자기만의 세계를 가꿔 둔 사람일수록 동반자와의 관계도 풍성해지는 역설—혼자 즐기는 책, 산책, 취미, 친구가 관능의 산소가 되는 @{structure}이다.',
    '50대 이후의관능은 "긴 동행의 농밀함" 으로 표현된다. 새 시작보다 오랜 동반자와의 관계 재발견이 가장 큰 자산—함께 늙어가는 사람과의 정기적 둘만의 시간을 의식적으로 디자인하는 사람이 관상이 약속한 후복의 결을 실현한다.',
  ]),
];
...
final List<_Frag> _sensualAdviceMale = [
  ...
  _Frag.hard(_isMid, [
    ...
    '30~40대 정점기의남성 관능은 일과 가정의 압박 사이에서 가장 쉽게 마비되는 영역이다. 직업적 성취가 관능의 우선순위를 자연스럽게 밀어내는 시기—주 1회 동반자와의 의식적 시간 확보가 40대 후반 결을 가꾸는 정공법이다. "바쁘다" 의 변명이 가장 큰 함정이다.',
    '30~40대 남성 관능의 핵심은 "관계 안의 새로움" 이다. 새 사람보다 같은 사람과의 새 장면을 만들 줄 아는 사람이 30~40대 정점기의 진짜 관능 결을 가꾼다. 침실의 변주, 여행, 공동 프로젝트 같은 의식적 설계가 평생 결을 결정한다.',
  ]),
  _Frag.hard(_isLate, [
...
final List<_Frag> _socialAdvice = [
  ...
  _Frag.hard(_isMid, [
    ...
    '중년 발복의 사회적 표현은 "대표성"입니다. 한 분야·한 집단을 대표하는 위치에 자연스럽게 서는 구간—@{mount_e}·@{mount_w}의 결이 이때 가장 큰 무게로 작동합니다. 책임을 회피하지 말고, 대표성의 무게를 받아들이는 것이 사회운의 다음 단계를 엽니다.',
  ...
  _Frag.hard(_isLate, [
    ...
    '50대 이후의 사회운은 "깊은 친구 3명"이 100명의 지인보다 가치 있는 구간입니다. 평생 함께해 온 동료와의 정기적 만남, 가족과의 시간 비중 재조정—이 두 가지가 노년 행복 곡선의 80%를 결정합니다. 새 인맥 추가의 욕심을 내려놓고 기존 관계를 두텁게 다지는 것이 후복의 정공법입니다.',
...
final List<_Frag> _talentAdvice = [
  ...
  _Frag.hard(_isMid, [
    '30~40대의 @{talent_word} 압축기—여러 시도가 한 줄기로 모이는 구간입니다. @__STRONGEST_NODE__의 결을 중심으로 다른 잔가지를 쳐 내야 진짜 깊이가 만들어지는 시기—지금 한 가지에 5,000시간을 투자하면 40대 후반에 "전문가"라는 라벨이 자연스럽게 따라옵니다. 다양성보다 집중이 중년 발복의 정직한 조건입니다.',
    '관상학이 "중년 발복"이라 부르는 시기는 재능의 결실기이기도 합니다. 30대 후반~40대 초반에 가장 큰 결과가 집결되는 리듬—그 시기를 놓치지 않으려면 지금 비축한 깊이가 충분해야 합니다. 다양성에서 깊이로의 전환, 실행에서 판단으로의 무게 이동이 이 시기의 핵심 과제입니다.',
    '30~40대 정점기의@{talent_word}은 "한 분야의 깊이로 다른 분야의 레버리지를 만드는" 단계입니다. 지금 자신의 전문성을 가르치는 자리·쓰는 자리·연결하는 자리로 의식적으로 확장하지 않으면, 40대 후반에 천장이 닫히기 시작합니다. @{palace_career}의 결을 충분히 키워두는 마지막 구간이 지금입니다.',
  ]),
  _Frag.hard(_isLate, [
    '50대 이후의 @{talent_word}은 "전수"가 핵심입니다. 자신이 쌓은 깊이를 다음 세대에게 흘려보낼 줄 아는 사람의 얼굴이 가장 빛나는 구간—제자·후배·공동체에 전달된 지혜가 자신의 후복으로 되돌아오는 구조입니다. 새로 쌓는 시도보다 잘 흘려보내는 설계가 평생 곡선의 마지막 30%를 만듭니다.',
    ...
    '50대 이후의재능은 "축적의 정직한 환원" 구간입니다. 평생 쌓은 경험을 책·강의·멘토링·자문 같은 외부 자산으로 전환하는 5~10년이 노년 후복의 가장 큰 정신적 자산—@__STRONGEST_NODE__의 결이 약속한 깊이는 이때 가장 풍성하게 되돌아옵니다.',
  ]),
];
...
final List<_Frag> _wealthAdvice = [
  ...
  _Frag.hard(_isYoung, [
    ...
    '관상학이 인생의 기반 형성기로 보는 지금은 단리에서 복리로 전환되는 7년의 임계점이 30대 초반에 옵니다. 매달 자동 저축 비율을 수입의 30% 이상으로 박아 두고, "한 번의 직장이 평생 곡선을 결정한다"는 함정에서 빠져나오십시오. @{palace_wealth}의 결은 지금 막 열리기 시작했을 뿐, 진짜 발복은 30~40대에 도래합니다.',
  ...
  _Frag.hard(_isMid, [
    '관상학이 "중년 발복"이라 부르는 30~40대 정점기입니다. @{mount_c}이 그 신호—지금 5~7년이 평생 총량의 70%를 결정하는 구간이며, 한 분야에서 충분히 깊어진 뒤 그 깊이로 다른 분야의 레버리지를 만들 줄 알아야 합니다. "안정"과 "확장" 사이의 균형이 자산 곡선의 기울기를 좌우하며, 발복 직후의 두 번째 확장이 가장 큰 함정입니다.',
    '30~40대 정점기의재운은 35~45세 사이에 자산 곡선의 기울기가 가장 가파릅니다. 코의 결이 살아 있는 사람일수록 이 구간의 변동성이 크니, 한 번의 성공을 두 번째 베팅으로 잘못 환산하면 평생 곡선이 평탄해집니다. @{palace_wealth}의 잠재력을 진짜로 실현하려면, 지금이 가장 보수적인 자산 배분이 필요한 역설의 시기입니다.',
    '40대는 "남의 돈·남의 시간"을 다루는 경험이 평생 자산 곡선을 결정짓는 시기입니다. 자기 노동으로만 버는 모델을 시스템·조직·자산이 버는 모델로 전환해야 40대 후반의 발복이 후복으로 이어집니다. 지금 키우는 사람·조직·구조가 50대 이후 자신을 대신해 일하는 자산이 됩니다.',
  ]),
  _Frag.hard(_isLate, [
    '50대 이후의 재물은 "쌓는 것"이 아니라 "잘 흘려보내는 것"입니다. @{mount_n}이 두터운 사람일수록 말년 자산의 기쁨은 소유보다 분배에서 옵니다. 자식·후배·공동체에 흐르는 돈이 다시 자신의 후복으로 되돌아오는 구조—증여·기부·투자의 비율을 명시적으로 설계해 두십시오. 한 번의 큰 손실이 평생 회복의 시간을 갉아먹지 않도록 방어선을 두텁게 까는 것이 핵심입니다.',
    '관상학이 "후복"이라 부르는 구간—후반의 묵직함이 자산의 가장 안정적 보호막입니다. 지금은 수익률을 좇기보다 자산 분산, 유동성, 상속 구조를 정비할 시기입니다. 50대 이후의 큰 결정은 반드시 가족·전문가와 공유하고, 단독 판단의 영역을 의식적으로 줄이는 것이 결정적입니다. @{palace_wealth}의 결이 약속한 후복은 잘 관리된 분배에서만 열립니다.',
    '60대 이후의 재물은 "건강·관계·자산" 셋의 균형에서만 의미를 갖습니다. 자산만 두텁고 건강·관계가 얇으면 후반의 결이 약속한 노년의 평온이 빠르게 흐려집니다. 지금은 자산을 늘리려는 욕심보다, 이미 쌓은 자산을 어떻게 의미 있게 흘려보낼지의 설계가 진짜 후복을 만듭니다.',
  ]),
];
...
final List<_Frag> _wealthStrength = [
  _Frag.hard((f) => f.fired('P-06') || f.nodeZ('nose') >= 1.0, [
    '@{mount_c}이 @{strong_adj} 자리잡은 구조는 관상학이 "중년 발복"이라 부르는 신호—30대 후반에서 40대 사이에 재물의 꼭짓점이 찾아오는 기질을 @{intense} 암시합니다.',
  ]),
  _Frag.hard((f) => f.fired('O-CK') || f.nodeZ('cheekbone') >= 0.8, [
  ...
  _Frag.hard((f) => f.fired('Z-04') || f.nodeZ('chin') >= 1.0, [
    '@{mount_n}이 @{strong_adj} 두터운 구조는 "말년재운"의 상징입니다. 50대 이후에도 재물의 뿌리가 마르지 않고 오히려 @{deep} 깊어지는 후복의 결입니다.',
  ]),
...
//   mid (30s~40s):    중년 정점기 — 발복·정점·실행기
//   late (50s+):      후반기 — 회수·전수·후복기
