...
final List<_Frag> _healthAdvice = [
  ...
  // age-stratified Advice — 上停·中停·下停 운의 건강 변곡점.
  _Frag.hard(_isYoung, [
    '上停 운의 건강은 "보이지 않는 누적"이 30대 중반에 한꺼번에 드러나는 결입니다. 지금 무리해도 다음 날 회복되는 능력이 가장 큰 함정—수면 부족·가공식품·불규칙 식사가 청구서로 돌아오는 시점은 5~10년 뒤입니다. 수면 7시간, 주 3회 운동, 한 가지 금연/금주 규칙을 30세 전에 박아 두는 사람만이 40대 의료비를 절반으로 줄입니다.',
    ...
    '上停 운의 정신 건강은 "기준 설정"의 시기입니다. 또래·SNS·비교의 압력 아래 자기만의 휴식 리듬을 못 박아 두는 사람만이 30대 이후 번아웃을 피합니다. @{palace_health}의 결이 약속한 잠재력은 지금의 무리가 아니라 지금의 규율에서 실현됩니다.',
  ]),
  _Frag.hard(_isMid, [
    '中停 운의 건강 변곡점—35~45세 사이에 몸의 누적이 처음으로 표면화되는 구간입니다. 20대에 쌓인 습관이 청구서로 돌아오는 시기—지금 정기 검진 주기를 1년으로 잡고, 가장 약한 한 가지 축(수면·식사·운동)을 우선 표준화하십시오. @{palace_health}의 결을 보호하는 가장 큰 방어선은 이 시기의 검진 누락 여부입니다.',
    '발복의 정점이 몸을 가장 많이 갉아먹는 시기이기도 합니다. 일·관계·자산의 동시 확장 압박 아래 자신의 건강이 마지막 우선순위로 밀리기 쉬운 구간—이때의 누적 피로가 50대 만성 질환의 직접 원인이 됩니다. 1년에 한 번 의무 검진과 매일 30분 운동의 두 가지 루틴만 박아 두십시오.',
    '中停의 건강은 "감정의 누적"이 신체로 옮겨가는 통로를 인식하는 데서 시작됩니다. 30~40대는 일과 가족 양쪽의 책임이 동시에 집중되는 구간이라, 해소되지 않은 스트레스가 특정 장기·관절·수면으로 직접 가는 패턴이 굳어지기 쉽습니다. 명상·상담·정기 운동 중 하나를 감정 배수로로 못 박아 두는 것이 결정적입니다.',
  ]),
  _Frag.hard(_isLate, [
    '下停 운의 건강은 "관리의 정밀함"이 결정합니다. 50대 이후는 회복력이 더 이상 자산이 아니므로—작은 신호 하나하나를 일찍 잡는 사람이 평균보다 10년 더 깨끗하게 살아갑니다. @{mount_n}의 두께가 그 잠재력을 약속하나, 그 약속을 실현하는 건 정기 점검 루틴뿐입니다. 자각 증상이 없는 시점의 검진이 평생 곡선을 결정합니다.',
    '관상학이 "말년의 신(神)이 빛난다"라 부르는 결—下停의 안정성이 노년 건강의 가장 큰 자산입니다. 다만 자신감 과잉이 함정—"아직 멀쩡하다"의 환상이 큰 병의 늦은 발견으로 이어지는 시기입니다. 60대 이후는 검진 주기를 6개월로 줄이고, "남이 늙는 속도"가 아닌 자신의 속도를 기준으로 삼으십시오.',
    '下停 운의 건강은 "관계의 두께"가 신체 회복력의 절반을 결정합니다. 가족·오랜 친구·공동체와의 정기적 접촉이 노년 면역의 가장 강력한 자산—고립이 어떤 만성 질환보다 빠르게 결을 흐립니다. 지금부터의 운동은 혼자가 아닌 함께하는 형태로 설계하는 것이 결정적입니다.',
  ]),
];
...
final List<_Frag> _romanceAdviceFemale = [
  ...
  // age-stratified Advice (♀) — 上停·中停·下停 운의 연애 변곡점.
  _Frag.hard(_isYoung, [
    '上停 운의 여성 연애는 "기준 설정"의 시기입니다. 20대는 어떤 사람과 만나는지보다 "어떤 사람과 안 맞는지"를 학습하는 구간—실패의 정직한 누적이 30대 이후 평온한 만남의 토양을 만듭니다. 한 사람의 외형이나 직업보다 함께 있을 때 자신이 어떤 사람이 되는지를 기준으로 삼는 훈련이 평생 @{palace_spouse}의 결을 좌우합니다.',
    '上停 운: 명궁이 인연의 진입 게이트입니다. 지금은 "이상형의 청사진"을 그리되 거기에 갇히지 않는 것이 중요한 시기—2030대에 만나는 사람의 80%는 결국 평생 동반자가 아닐 가능성이 높으므로, 결과보다 과정에서 배우는 자세가 평생 연애 곡선의 깊이를 만듭니다.',
  ...
  _Frag.hard(_isMid, [
    '中停 운의 여성 연애는 "안정 설계"의 시기입니다. 30~40대의 만남은 폭발적 감정보다 일상 운영 능력으로 평가받는 구간—함께 살림·자녀·재무를 굴릴 수 있는 사람인지가 핵심입니다. @{palace_spouse}의 결이 이때 가장 의미 있게 활성화되며, 감정의 정점보다 일상의 평균치가 결정적입니다.',
    '관상학이 "中停 부부궁(夫婦宮)"이라 부르는 구간은 단순한 사랑보다 동행 능력을 본다고 일러줍니다. 지금의 인연은 "5년 뒤 같이 살 수 있는가"가 가장 정직한 기준—말의 화려함보다 일상의 사소한 합의가 잘 되는 사람을 알아보는 눈이 가장 큰 자산입니다.',
  ...
  _Frag.hard(_isLate, [
    '下停 운의 여성 연애는 "동행"이 핵심입니다. 50대 이후의 인연은 새로운 시작보다 오랜 동반자와의 관계 갱신이 가장 큰 행복원—함께 늙어가는 사람과의 일상 리듬을 의식적으로 디자인하십시오. 자녀가 떠난 뒤 둘이 남는 시간이 길어지는 구간이라, 그 시간을 적극적으로 채울 공동 취미·여행·프로젝트가 결정적입니다.',
    '관상학이 "후복(後福)의 부부궁"이라 부르는 구간—下停의 결이 노년 동반자 관계의 안정성을 약속합니다. 다만 "관계의 새 페이지"를 함께 펴는 작업이 의식적이지 않으면 침묵의 누적으로 결이 흐려지는 시기—매년 둘만의 의례를 새로 하나씩 만드는 습관이 후복을 두텁게 합니다.',
...
final List<_Frag> _romanceAdviceMale = [
  ...
  // age-stratified Advice (♂) — 上停·中停·下停 운의 남성 연애 변곡점.
  _Frag.hard(_isYoung, [
    '上停 운의 남성 연애는 "시작과 실패"의 시기입니다. 20대 남성의 만남은 잘 되는 것보다 잘 헤어지는 법을 배우는 구간—깨끗한 마무리가 다음 인연의 토양을 만들어냅니다. 외형·인기·트렌드에 휘둘리기 쉬운 구간이지만, 그 패턴 안에서 자신이 어떤 사람으로 변하는지를 관찰하는 것이 이후 30년의 기준이 됩니다.',
    '上停 운: 명궁의 결이 첫 인연들의 패턴을 결정합니다. 지금은 "기준을 만드는" 시기이지 "결정을 내리는" 시기가 아닙니다—20대에 만난 사람이 평생 동반자가 될 확률은 통계적으로 낮으므로, 결과보다 과정에서 배우는 자세가 핵심입니다. 한 번의 정직한 이별이 다음 인연 세 번의 깊이를 만듭니다.',
    '20대 남성의 연애운에서 가장 큰 함정은 "외형의 비교"입니다. 키·외모·인기 차이를 매력의 본질로 환원하는 시기—그 비교에서 자유로워지는 사람만이 30대 中停 발복기에 진짜 매력의 결을 키웁니다. 지금은 자기 결의 깊이(직업·취미·세계관)를 쌓는 게 가장 큰 연애 자산입니다.',
  ]),
  _Frag.hard(_isMid, [
    '中停 운의 남성 연애는 "능력의 가시화"가 핵심입니다. 30~40대 남성의 매력은 외형보다 "함께 미래를 그릴 수 있는 사람인가"가 기준이 되는 구간—직업적 안정과 가치관의 일관성이 매력의 두 축입니다. @{palace_spouse}의 결이 이때 가장 의미 있게 작동합니다.',
    '中停 부부궁(夫婦宮)의 발복은 남성에게 "결단의 시기"로 다가옵니다. 평생 동반자에 대한 책임을 받아들일 준비—이 결단을 미루는 시기가 길어질수록 中停의 결이 흐려지는 패턴이 따라옵니다. 30대 후반의 결정이 평생 가정·자녀·후복 곡선을 좌우합니다.',
    '30~40대 남성 연애의 가장 큰 함정은 "성취의 분산"입니다. 직업·자산·취미·관계의 동시 확장 압박 아래 가장 먼저 희생되는 것이 동반자와의 시간—주 1회 둘만의 시간을 의무적으로 박아 두는 사람만이 中停 후반의 가정운을 지킵니다. 가정은 짓는 것이 아니라 매주 지키는 것입니다.',
  ]),
  _Frag.hard(_isLate, [
    '下停 운의 남성 연애는 "동반자 가치 재발견"의 시기입니다. 50대 이후 함께해 온 사람의 의미가 가장 깊어지는 구간—젊은 시절의 빛나는 감정보다 오랜 동행이 만든 결의 깊이가 진짜 매력으로 작동합니다. @{mount_n}의 두께가 그 잠재력을 약속합니다.',
    '관상학이 "후복(後福)"의 결이라 부르는 시기—下停의 묵직함이 동반자에게 안정감을 주는 자산입니다. 이 시기의 관계 재정비—함께 늙어갈 공통의 리듬, 함께 가질 취미, 함께 갈 여행—이 노년 행복의 80%를 결정합니다. 자식이 떠난 뒤 둘이 남는 시간을 적극적으로 설계하지 않으면 침묵으로 흐립니다.',
    '50대 이후 남성 연애의 가장 큰 함정은 "은퇴 후 역할 상실"입니다. 직업적 정체성이 사라진 자리를 동반자와의 새로운 역할로 채우지 못하면 가정 내 무기력이 빠르게 누적됩니다. 둘만의 새 프로젝트—여행·취미·자원봉사·자식 양육 지원—를 의식적으로 만드는 것이 후복의 핵심입니다.',
  ]),
];
...
final List<_Frag> _sensualAdviceFemale = [
  ...
  // age-stratified Advice (♀) — 30+ gated, 中停 vs 下停 운의 관능 변곡점.
  _Frag.hard(_isMid, [
    '中停 운의 여성 관능은 "깊이의 시기" 이다. 20대의 외형적 매력이 한층 농밀해지는 구간—직접적 신호보다 분위기, 태도, 여운이 핵심 매력 자산이 된다. @{palace_spouse}의 결이 이때 가장 의미 있게 작동하고, 자기 속도를 알아본 사람만이 진짜 관능의 결을 발견한다.',
    ...
    '中停의 여성 관능은 일과 가정의 압박 사이에서 가장 쉽게 후순위로 밀린다. "관능의 우선순위 보호" 가 中停 발복기의 숨은 핵심—주 1회라도 자기만의 감각 시간(향, 음악, 산책, 책)을 의식적으로 확보하는 사람만이 40대 후반의 결을 가꾼다.',
  ]),
  _Frag.hard(_isLate, [
    '下停 운의 여성 관능은 "존재감" 의 결이다. 50대 이후 여성의 매력은 외형보다 자신만의 결정, 경험, 내공이 만든 깊이—"아직도 매력적인" 의 무게가 "처음 매력적인" 보다 깊다. @{palace_spouse}의 결이 후복(後福) 의 형태로 다시 활성화되는 시기이다.',
    '50대 이후의 여성 관능은 "혼자의 시간" 의 질이 결정한다. 자기만의 세계를 가꿔 둔 사람일수록 동반자와의 관계도 풍성해지는 역설—혼자 즐기는 책, 산책, 취미, 친구가 관능의 산소가 되는 @{structure}이다.',
    '下停 운의 관능은 "긴 동행의 농밀함" 으로 표현된다. 새 시작보다 오랜 동반자와의 관계 재발견이 가장 큰 자산—함께 늙어가는 사람과의 정기적 둘만의 시간을 의식적으로 디자인하는 사람이 관상이 약속한 후복의 결을 실현한다.',
  ]),
];
...
final List<_Frag> _sensualAdviceMale = [
  ...
  // age-stratified Advice (♂) — 30+ gated, 中停 vs 下停 운의 관능 변곡점.
  _Frag.hard(_isMid, [
    '中停 운의 남성 관능은 "책임감의 매력" 으로 작동한다. 30~40대 남성의 관능은 외형보다 안정성, 신뢰, 일관성—@{mount_n}의 결이 그 무게의 핵심 자산이다. 외부 인기보다 동반자가 인정하는 매력이 평생 농도의 절반을 결정한다.',
    '中停의 남성 관능은 일과 가정의 압박 사이에서 가장 쉽게 마비되는 영역이다. 직업적 성취가 관능의 우선순위를 자연스럽게 밀어내는 시기—주 1회 동반자와의 의식적 시간 확보가 中停 후반 결을 가꾸는 정공법이다. "바쁘다" 의 변명이 가장 큰 함정이다.',
    '30~40대 남성 관능의 핵심은 "관계 안의 새로움" 이다. 새 사람보다 같은 사람과의 새 장면을 만들 줄 아는 사람이 中停 발복기의 진짜 관능 결을 가꾼다. 침실의 변주, 여행, 공동 프로젝트 같은 의식적 설계가 평생 결을 결정한다.',
  ]),
  _Frag.hard(_isLate, [
    '下停 운의 남성 관능은 "오랜 깊이" 의 결이다. 50대 이후 매력의 무게는 외형보다 인생을 어떻게 살아왔는가의 흔적—얼굴의 결이 곧 인생의 결로 읽히는 시기이다. 자기 결을 가꿔온 사람의 묵직함이 가장 큰 관능 자산이다.',
    '50대 이후의 남성 관능은 "은퇴 이후의 새 역할" 에서 가장 크게 달라진다. 직업적 정체성이 사라진 자리를 동반자와의 새로운 친밀함으로 채우지 못하면 결이 빠르게 흐려지는 시기—둘만의 정기적 의례를 의식적으로 만드는 것이 후복의 핵심이다.',
    '下停의 남성 관능은 "느림의 미학" 이 핵심이다. 폭발적 강도보다 긴 호흡의 동행, 일상의 사소한 친밀함—함께 마시는 커피, 같이 보는 풍경, 매년 가는 여행지—이 노년 관능 결의 진짜 자산이다.',
  ]),
];
...
final List<_Frag> _socialAdvice = [
  ...
  // age-stratified Advice — 上停·中停·下停 운의 사회운 변곡점.
  _Frag.hard(_isYoung, [
    '上停 운의 사회운은 "넓이"가 핵심입니다. 20대의 인간관계는 깊이보다 폭—여러 분야·세대·문화권의 사람을 만나본 폭이 30대 이후 진짜 네트워크의 토양이 됩니다. 한 그룹에 일찍 굳어지면 35세 이후 관계 곡선이 좁아지는 구조이므로, 지금은 의식적으로 자기와 다른 결의 사람을 만나는 자리를 만들어 두십시오.',
    '上停 운: 이마와 명궁이 사회적 신뢰의 진입 게이트입니다. 지금은 평판의 씨앗을 뿌리는 시기—한 번의 작은 약속·납기·태도가 10년 뒤 평판의 토대가 되므로, 사소한 신뢰부터 정직하게 쌓아 두십시오. @{palace_social}의 결은 화려한 인맥이 아니라 지킨 약속의 누적으로 만들어집니다.',
  ...
  _Frag.hard(_isMid, [
    '中停 운의 사회운은 "영향력의 시기"입니다. 20대에 쌓은 네트워크가 처음으로 자산으로 환원되는 구간—단순한 친분에서 협업·추천·기회로 발전하는 단계입니다. 받는 만큼 흘려보내는 균형이 무너지면 네트워크가 빠르게 식는 시기이기도 하며, 지금의 평판이 평생 무게가 됩니다.',
    '中停 발복의 사회적 표현은 "대표성"입니다. 한 분야·한 집단을 대표하는 위치에 자연스럽게 서는 구간—@{mount_e}·@{mount_w}의 결이 이때 가장 큰 무게로 작동합니다. 책임을 회피하지 말고, 대표성의 무게를 받아들이는 것이 사회운의 다음 단계를 엽니다.',
  ...
  _Frag.hard(_isLate, [
    '下停 운의 사회운은 "멘토링"의 결입니다. 자신이 쌓은 인맥과 통찰을 후배에게 흘려보내는 능력—이 흐름이 자신의 노년을 외롭지 않게 만드는 가장 큰 보호막입니다. @{mount_n}의 두께가 그 잠재력을 약속하나, 의식적인 자리 만들기가 필요합니다.',
    '50대 이후의 사회운은 "깊은 친구 3명"이 100명의 지인보다 가치 있는 구간입니다. 평생 함께해 온 동료와의 정기적 만남, 가족과의 시간 비중 재조정—이 두 가지가 노년 행복 곡선의 80%를 결정합니다. 새 인맥 추가의 욕심을 내려놓고 기존 관계를 두텁게 다지는 것이 후복(後福)의 정공법입니다.',
    '下停 운의 사회운은 "느슨한 공동체"가 노년 정신 건강의 가장 큰 자산입니다. 의무 없는 정기 모임—오래된 친구 모임, 공동 취미 그룹, 정기 산책 모임—을 의식적으로 박아 두는 사람이 평균보다 10년 더 정신적으로 깨끗하게 살아갑니다.',
  ]),
];
...
final List<_Frag> _talentAdvice = [
  ...
  // age-stratified Advice — 上停·中停·下停 운의 재능 변곡점.
  _Frag.hard(_isYoung, [
    '上停 운의 @{talent_word}은 "시도의 폭"이 결정합니다. 한 길에 일찍 굳어지지 마십시오—@__STRONGEST_NODE__의 결을 알아도 그 결이 어떤 영역에서 가장 빛나는지 찾는 데는 5~7년의 다양한 시도가 필요합니다. 20대의 정직한 실패가 30대의 압축된 재능 곡선을 만드는 정공법—지금은 한 가지에 갇히지 말고, 세 갈래를 동시에 얕게 시도하는 것이 후반 곡선의 가파름을 결정합니다.',
    '上停 운: 이마와 명궁이 재능의 진입 게이트로 작동하는 시기입니다. 머리로 배우는 속도가 평생 가장 빠른 구간—지금 익히는 한 가지 기술·언어·도구가 평생 나의 "기본 자산"으로 남으므로, 깊이보다 "뼈대 다지기"에 시간을 투자하십시오. 30대 中停 발복기에 진짜 압축이 시작되니, 그전에 폭을 최대로 벌려두는 것이 정답입니다.',
  ...
  _Frag.hard(_isMid, [
    '中停 운의 @{talent_word} 압축기—여러 시도가 한 줄기로 모이는 구간입니다. @__STRONGEST_NODE__의 결을 중심으로 다른 잔가지를 쳐 내야 진짜 깊이가 만들어지는 시기—지금 한 가지에 5,000시간을 투자하면 40대 후반에 "전문가"라는 라벨이 자연스럽게 따라옵니다. 다양성보다 집중이 中停 발복의 정직한 조건입니다.',
    '관상학이 "中停 발복"이라 부르는 시기는 재능의 결실기이기도 합니다. 30대 후반~40대 초반에 가장 큰 결과가 집결되는 리듬—그 시기를 놓치지 않으려면 지금 비축한 깊이가 충분해야 합니다. 다양성에서 깊이로의 전환, 실행에서 판단으로의 무게 이동이 이 시기의 핵심 과제입니다.',
    '中停의 @{talent_word}은 "한 분야의 깊이로 다른 분야의 레버리지를 만드는" 단계입니다. 지금 자신의 전문성을 가르치는 자리·쓰는 자리·연결하는 자리로 의식적으로 확장하지 않으면, 40대 후반에 천장이 닫히기 시작합니다. @{palace_career}의 결을 충분히 키워두는 마지막 구간이 지금입니다.',
  ]),
  _Frag.hard(_isLate, [
    '下停 운의 @{talent_word}은 "전수"가 핵심입니다. 자신이 쌓은 깊이를 다음 세대에게 흘려보낼 줄 아는 사람의 얼굴이 가장 빛나는 구간—제자·후배·공동체에 전달된 지혜가 자신의 후복(後福)으로 되돌아오는 구조입니다. 새로 쌓는 시도보다 잘 흘려보내는 설계가 평생 곡선의 마지막 30%를 만듭니다.',
    ...
    '下停 운의 재능은 "축적의 정직한 환원" 구간입니다. 평생 쌓은 경험을 책·강의·멘토링·자문 같은 외부 자산으로 전환하는 5~10년이 노년 후복의 가장 큰 정신적 자산—@__STRONGEST_NODE__의 결이 약속한 깊이는 이때 가장 풍성하게 되돌아옵니다.',
  ]),
];
...
final List<_Frag> _wealthAdvice = [
  ...
  // age-stratified Advice — 麻衣相法 12 궁 시간 분포 grounded.
  _Frag.hard(_isYoung, [
    '上停 운의 재물 신호는 "시작의 폭"에 있습니다. 한 직업·한 회사에 일찍 굳어지지 마십시오. 20대 후반까지 두세 갈래의 수입원을 시도해 본 사람만이 30대 中停 발복기에 진짜 곡선의 기울기를 찾는 결—실패의 정직한 누적이 그대로 자산 설계 능력으로 환원되는 @{structure}입니다. 지금은 적은 액수라도 "고정 저축의 자동화"를 박아 두는 것이 5년 뒤 종잣돈의 절대 크기를 결정합니다.',
    '관상학이 上停 운이라 부르는 지금은 단리에서 복리로 전환되는 7년의 임계점이 30대 초반에 옵니다. 매달 자동 저축 비율을 수입의 30% 이상으로 박아 두고, "한 번의 직장이 평생 곡선을 결정한다"는 함정에서 빠져나오십시오. @{palace_wealth}의 결은 지금 막 열리기 시작했을 뿐, 진짜 발복은 中停에 도래합니다.',
  ...
  _Frag.hard(_isMid, [
    '관상학이 "중년발복(中年發福)"이라 부르는 中停 운의 정점기입니다. @{mount_c}이 그 신호—지금 5~7년이 평생 총량의 70%를 결정하는 구간이며, 한 분야에서 충분히 깊어진 뒤 그 깊이로 다른 분야의 레버리지를 만들 줄 알아야 합니다. "안정"과 "확장" 사이의 균형이 자산 곡선의 기울기를 좌우하며, 발복 직후의 두 번째 확장이 가장 큰 함정입니다.',
    '中停의 재운은 35~45세 사이에 자산 곡선의 기울기가 가장 가파릅니다. 코의 결이 살아 있는 사람일수록 이 구간의 변동성이 크니, 한 번의 성공을 두 번째 베팅으로 잘못 환산하면 평생 곡선이 평탄해집니다. @{palace_wealth}의 잠재력을 진짜로 실현하려면, 지금이 가장 보수적인 자산 배분이 필요한 역설의 시기입니다.',
    '40대는 "남의 돈·남의 시간"을 다루는 경험이 평생 자산 곡선을 결정짓는 시기입니다. 자기 노동으로만 버는 모델을 시스템·조직·자산이 버는 모델로 전환해야 中停 후반의 발복이 후복(後福)으로 이어집니다. 지금 키우는 사람·조직·구조가 50대 이후 자신을 대신해 일하는 자산이 됩니다.',
  ]),
  _Frag.hard(_isLate, [
    '下停 운의 재물은 "쌓는 것"이 아니라 "잘 흘려보내는 것"입니다. @{mount_n}이 두터운 사람일수록 말년 자산의 기쁨은 소유보다 분배에서 옵니다. 자식·후배·공동체에 흐르는 돈이 다시 자신의 후복(後福)으로 되돌아오는 구조—증여·기부·투자의 비율을 명시적으로 설계해 두십시오. 한 번의 큰 손실이 평생 회복의 시간을 갉아먹지 않도록 방어선을 두텁게 까는 것이 핵심입니다.',
    '관상학이 "후복(後福)"이라 부르는 구간—下停의 묵직함이 자산의 가장 안정적 보호막입니다. 지금은 수익률을 좇기보다 자산 분산, 유동성, 상속 구조를 정비할 시기입니다. 50대 이후의 큰 결정은 반드시 가족·전문가와 공유하고, 단독 판단의 영역을 의식적으로 줄이는 것이 결정적입니다. @{palace_wealth}의 결이 약속한 후복은 잘 관리된 분배에서만 열립니다.',
    '60대 이후의 재물은 "건강·관계·자산" 셋의 균형에서만 의미를 갖습니다. 자산만 두텁고 건강·관계가 얇으면 下停의 결이 약속한 노년의 평온이 빠르게 흐려집니다. 지금은 자산을 늘리려는 욕심보다, 이미 쌓은 자산을 어떻게 의미 있게 흘려보낼지의 설계가 진짜 후복을 만듭니다.',
  ]),
];
...
// 연령대 hard predicate — 麻衣相法 12 궁 시간 분포 grounded.
//   young (10s~20s):  上停 운 (印堂·이마) — 잠재·탐색·기반 형성기
//   mid (30s~40s):    中停 운 (코·광대·눈썹) — 발복·정점·실행기
//   late (50s+):       下停 운 (입·턱·지각) — 회수·전수·후복기
