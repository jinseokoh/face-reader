...
final List<_Frag> _v2WealthOpening = [
  ...
  _Frag(_bandPair(Attribute.wealth, _Band.high, Attribute.stability, _Band.low), [
    '@{verdict:wealth} 다만 안정성은 낮은 쪽입니다. 전통 관상은 코가 실하고 턱이 얇은 얼굴을 두고 들어오는 폭과 나가는 폭이 함께 큰 상이라 했어요.',
  ]),
  _Frag(_bandPair(Attribute.wealth, _Band.mid, Attribute.stability, _Band.high), [
    '@{verdict:stability} 재력 항목은 평균대예요. 전통 관상은 턱을 노복궁으로 두고, 이 자리가 두터운 얼굴을 지키는 힘이 앞선 상으로 읽었어요.',
  ]),
  _Frag(_bandPair(Attribute.wealth, _Band.mid, Attribute.stability, _Band.mid), [
    '@{verdict:wealth} 안정성도 비슷한 자리에 있습니다. 전통 관상은 어느 한 자리가 유독 튀지 않고 고른 얼굴을 두고 균형이 잡힌 상이라 합니다.',
  ...
  _Frag(_bandPair(Attribute.wealth, _Band.low, Attribute.stability, _Band.high), [
    '@{verdict:wealth} 대신 안정성은 높은 쪽입니다. 전통 관상은 코보다 턱이 발달한 얼굴을 두고 만드는 쪽보다 지키는 쪽이 강한 상이라 했어요.',
  ]),
...
final List<_Frag> _v2WealthVignette = [
  _Frag(_highOf(Attribute.wealth), [
    '옛 관상서는 재백궁이 실한 얼굴을 두고 재물이 들어오는 길이 열려 있다고 읽어 왔어요.',
  ]),
  _Frag(_highOf(Attribute.stability), [
    '옛 관상서는 턱이 두터운 얼굴을 두고 자리를 오래 지키는 힘이 있다고 봅니다.',
  ]),
...
final List<_Frag> _v2WealthStrength = [
  ...
  _Frag.hard((f) => f.fired('Z-11'), [
    '얼굴 가운데 구역의 항목들이 고르게 높습니다. 관상서는 얼굴을 위·가운데·아래 세 구역으로 나누어 보았고, 가운데가 고른 얼굴을 힘이 실린 상이라 했어요.',
  ]),
  ...
  _Frag.hard((f) => true, [
    ...
    '옛 관상서는 코가 홀로 큰 얼굴보다 이마와 턱이 받쳐 주는 얼굴을 더 높게 봤어요.',
...
final List<_Frag> _v2WealthShadow = [
  ...
  _Frag(_lowOf(Attribute.wealth), [
    '다만 전통 관상은 재백궁이 얇은 얼굴을 두고 들어오는 것보다 나가는 것이 잦은 상이라 읽었어요.',
  ]),
  _Frag.hard((f) => f.fired('Z-09') || f.bandOf(Attribute.emotionality) == _Band.high, [
    '다만 눈과 눈썹 항목의 값이 함께 높습니다. 전통 관상은 이 자리가 강한 얼굴을 두고 마음이 먼저 움직이는 상이라 했고, 재물을 두고도 그 기운이 함께 실린다고 보았어요.',
  ]),
  _Frag(_lowOf(Attribute.stability), [
    '다만 턱 항목의 값이 낮은 쪽입니다. 전통 관상은 노복궁이 얇은 얼굴을 두고 얻은 것을 오래 두기 어려운 상이라 했어요.',
  ]),
  _Frag.hard((f) => true, [
    '다만 전통 관상은 재백궁 하나만 보고 판단하지 않았어요. 이마와 턱이 받쳐 주지 않으면 그 자리만으로는 읽지 않았습니다.',
    '다만 옛 관상서는 콧방울이 벌어진 얼굴을 두고 들어오는 폭만큼 나가는 폭도 넓다고 합니다.',
    '다만 전통 관상은 광대가 지나치게 선 얼굴을 두고 나서는 힘이 앞선다고 보았습니다.',
    '다만 전통 관상은 한 자리가 유독 두드러진 얼굴보다 여러 자리가 고른 얼굴을 높게 봤어요.',
    '다만 옛 관상서는 상은 마음에서 나온다 하여, 얼굴을 고정된 것으로 보지 않았어요.',
  ]),
];
...
final List<_Frag> _v2WealthAdvice = [
  ...
  _Frag(_bandPair(Attribute.wealth, _Band.high, Attribute.stability, _Band.mid), [
    '전통 관상은 재백궁이 실하고 노복궁이 평이한 얼굴에 기회를 좇되 발을 빼는 때를 미리 정해 두라 했어요. 좋은 구간에 규모를 키우지 않는 규칙 하나가 그 역할을 합니다.',
  ]),
  _Frag(_bandPair(Attribute.wealth, _Band.high, Attribute.stability, _Band.low), [
  ...
  _Frag(_bandPair(Attribute.wealth, _Band.mid, Attribute.stability, _Band.mid), [
    '전통 관상은 어느 자리도 치우치지 않은 얼굴을 두고 습관이 그대로 상이 된다고 했어요. 고정 저축을 수입의 25% 이상으로 자동화해 두는 것이 가장 단순한 적용입니다.',
  ]),
  _Frag(_bandPair(Attribute.wealth, _Band.mid, Attribute.stability, _Band.low), [
    '전통 관상은 마음이 먼저 움직이는 상에 큰일을 하루 묵히라 합니다. 큰 금전 결정을 24시간 미루는 규칙 하나면 충분합니다.',
  ]),
  _Frag(_bandPair(Attribute.wealth, _Band.low, Attribute.stability, _Band.high), [
    '전통 관상은 노복궁이 실하고 재백궁이 순한 얼굴에 자리를 오래 지키는 쪽을 권했습니다. 근로·전문직·장기 근속이 그 방향이고, 버는 기술보다 안 쓰는 기준에 시간을 들이는 편이 낫습니다.',
  ]),
  _Frag(_bandPair(Attribute.wealth, _Band.low, Attribute.stability, _Band.mid), [
    '전통 관상은 재백궁이 두드러지지 않은 얼굴을 낮게 보지 않았고, 다만 습관이 그대로 드러난다고 했어요. 자동 이체 저축의 효과가 이 구성에서 가장 단순하게 나타납니다.',
  ]),
  _Frag(_lowPair(Attribute.wealth, Attribute.stability), [
    '전통 관상은 열두 자리 가운데 실한 곳을 찾아 그 자리를 쓰라고 합니다. 재백궁이 아니라면 재능·관계·경험 쪽을 중심에 두고 돈은 따라오게 두는 편이 낫습니다.',
  ]),
  _Frag.hard((f) => true, [
    '전통 관상은 재물을 이마·코·광대·턱 네 자리로 나누어 봅니다. 값이 가장 낮은 자리부터 손보는 순서가 가장 단순합니다.',
    '옛 관상서는 재백궁이 실해도 마음이 흐트러지면 그 자리가 무너진다고 했습니다. 감정이 올라온 구간의 결정을 미루는 규칙이 그에 해당합니다.',
    '전통 관상은 한 번에 크게 얻는 것보다 흐트러지지 않는 쪽을 높게 보았어요. 큰 베팅 한 번보다 매달 도는 고정 저축이 그 방향이에요.',
...
final List<_Frag> _v2HealthOpening = [
  _Frag(_highPair(Attribute.stability, Attribute.emotionality), [
    '@{verdict:stability} 감정성 항목도 함께 높게 나왔습니다. 전통 관상은 코를 질액궁이라 하여 몸의 자리로도 봅니다. 산근이 곧으면서 눈에 물기가 도는 얼굴은 기운이 살아 있는 상으로 읽어요.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.high, Attribute.emotionality, _Band.mid), [
    '@{verdict:stability} 감정성은 평균대입니다. 전통 관상은 코를 질액궁이라 하여 병과 액이 드러나는 자리로 보았고, 이 자리가 곧은 얼굴을 몸이 고른 상이라 했어요.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.high, Attribute.emotionality, _Band.low), [
    '@{verdict:stability} 감정성은 낮은 쪽입니다. 전통 관상은 얼굴에 기복이 적은 상을 두고 안으로 눌러 두는 힘이 강하다고 봤어요.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.mid, Attribute.emotionality, _Band.high), [
    '@{verdict:emotionality} 안정성은 평균대예요. 전통 관상은 눈을 사독 가운데 하(河)라 하여 기운이 흐르는 자리로 봅니다. 이 자리가 강한 얼굴은 안팎의 진폭이 크다고 했어요.',
  ]),
  ...
  _Frag(_bandPair(Attribute.stability, _Band.mid, Attribute.emotionality, _Band.low), [
    '@{verdict:emotionality} 안정성은 평균대입니다. 전통 관상은 표정의 움직임이 적은 얼굴을 두고 속을 밖으로 내지 않는 상이라 했어요.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.low, Attribute.emotionality, _Band.high), [
    '@{verdict:stability} 대신 감정성은 높은 쪽입니다. 전통 관상은 산근이 얕고 눈의 기운이 센 얼굴을 두고 기복이 몸에 먼저 나타나는 상이라 합니다.',
  ]),
...
final List<_Frag> _v2HealthVignette = [
  ...
  _Frag.hard((f) => true, [
    ...
    '옛 관상서는 몸을 코 하나로 보지 않고 눈·눈썹·턱의 기운을 함께 놓고 읽었어요.',
    '옛 관상서는 질액궁이 곧아도 얼굴에 핏기가 없으면 그 자리만으로 읽지 않았어요.',
  ]),
];
...
final List<_Frag> _v2HealthStrength = [
  ...
  _Frag.hard((f) => true, [
    '관상서는 몸을 이마·산근·눈·턱 네 자리로 나누어 봅니다. 이 얼굴은 그 가운데 여러 자리가 평균 부근에 고르게 놓여 있습니다.',
    '옛 관상서는 한 자리가 유독 튀는 얼굴보다 네 자리가 고른 얼굴을 몸에서는 더 좋게 보았어요.',
    ...
    '옛 관상서는 질액궁의 크기보다 그 자리에 흠이 없는지를 먼저 봤어요.',
  ]),
];

final List<_Frag> _v2HealthShadow = [
  _Frag(_highPair(Attribute.stability, Attribute.emotionality), [
    '다만 전통 관상은 버티는 힘과 감정의 기운이 함께 센 얼굴을 두고, 지쳐도 티가 늦게 난다고 했어요.',
  ]),
  _Frag(_lowOf(Attribute.stability), [
    '다만 전통 관상은 산근이 얕은 얼굴을 두고 한 번 무너지면 회복이 더디다고 봅니다.',
  ]),
  _Frag(_highOf(Attribute.stability), [
    '다만 옛 관상서는 버티는 힘이 센 상을 두고, 참는 것이 길어져 때를 놓치기 쉽다고도 합니다.',
  ]),
  _Frag(_highOf(Attribute.emotionality), [
    '다만 전통 관상은 눈의 기운이 센 얼굴을 두고 마음의 기복이 몸으로 먼저 내려간다고 했습니다.',
  ]),
  _Frag.hard((f) => true, [
    '다만 전통 관상은 질액궁 하나만 보고 판단하지 않았습니다. 얼굴빛과 눈의 기운을 함께 보지 않으면 그 자리만으로는 읽지 않았어요.',
    '다만 옛 관상서는 얼굴의 모양보다 그날의 빛이 몸을 먼저 알린다고 했어요.',
    '다만 전통 관상은 자리가 좋아도 생활이 어지러우면 그 자리가 흐려진다고 보았어요.',
...
final List<_Frag> _v2HealthAdvice = [
  _Frag(_highPair(Attribute.stability, Attribute.emotionality), [
    '전통 관상은 기운이 센 상에 오히려 덜어내는 쪽을 권합니다. 버틸 수 있다는 감각이 회복 시점을 늦추니, 피로를 느낀 날짜를 적어 두는 정도면 충분합니다.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.high, Attribute.emotionality, _Band.mid), [
    '전통 관상은 질액궁이 곧은 얼굴에 지금의 상태를 유지하는 쪽을 권했습니다. 수면 시각을 고정하는 것 하나가 가장 단순한 유지법이에요.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.high, Attribute.emotionality, _Band.low), [
    '전통 관상은 안으로 눌러 두는 상에 밖으로 내보내는 통로를 하나 두라 했어요. 몸을 쓰는 운동이 그 통로 역할을 합니다.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.mid, Attribute.emotionality, _Band.high), [
    '전통 관상은 기운의 진폭이 큰 상에 하루의 시작과 끝을 같게 두라 합니다. 기상과 취침 시각을 고정하는 것이 그에 해당합니다.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.mid, Attribute.emotionality, _Band.mid), [
    '전통 관상은 치우치지 않은 상을 두고 생활이 그대로 얼굴빛에 나타난다고 했습니다. 수면·식사 시각을 일정하게 두는 것만으로 대부분이 정리됩니다.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.mid, Attribute.emotionality, _Band.low), [
    '전통 관상은 표정이 적은 상에 몸의 신호를 말로 옮겨 두라 했어요. 어디가 어떻게 불편한지 적어 두면 진료에서 가장 크게 작동합니다.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.low, Attribute.emotionality, _Band.high), [
    '전통 관상은 산근이 얕고 기운이 센 상에 무리를 짧게 끊으라 합니다. 몰아서 쉬는 것보다 매일 조금씩 끊어 쉬는 쪽이 이 조언에 맞습니다.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.low, Attribute.emotionality, _Band.mid), [
    '전통 관상은 버티는 힘이 약한 상에 미리 정한 선을 두라 했습니다. 몇 시 이후에는 일을 잡지 않는 규칙 하나면 됩니다.',
  ]),
  _Frag(_lowPair(Attribute.stability, Attribute.emotionality), [
    '전통 관상은 열두 자리 가운데 실한 곳을 찾아 그 자리를 쓰라고 했어요. 몸을 밀어붙이는 방식보다 회복 시간을 먼저 확보하는 순서가 낫습니다.',
  ]),
  _Frag.hard((f) => true, [
    ...
    '전통 관상은 병을 얻은 뒤보다 얻기 전을 보려 했어요. 증상이 없을 때 받는 검진이 그 뜻에 가장 가깝습니다.',
  ]),
  _Frag.hard(_isYoung, [
...
final List<_Frag> _v2RomanceOpening = [
  _Frag(_bandPair(Attribute.attractiveness, _Band.high, Attribute.emotionality, _Band.high), [
    '@{verdict:attractiveness} 감정성 항목도 함께 높게 나왔습니다. 전통 관상은 눈꼬리 자리를 처첩궁이라 하여 배우자 인연을 보는 곳으로 여겼고, 이 자리에 기운이 실린 얼굴을 사람이 모이는 상으로 읽었어요.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.high, Attribute.emotionality, _Band.mid), [
    '@{verdict:attractiveness} 감정성은 평균대예요. 전통 관상은 처첩궁이 도톰한 얼굴을 두고 인연이 늦지 않은 상이라 합니다.',
  ]),
  ...
  _Frag(_bandPair(Attribute.attractiveness, _Band.mid, Attribute.emotionality, _Band.high), [
    '@{verdict:emotionality} 매력도는 평균대입니다. 전통 관상은 눈을 사독 가운데 하(河)라 하여 정이 흐르는 자리로 보았고, 이 자리가 강한 얼굴을 마음을 깊게 쓰는 상이라 했어요.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.mid, Attribute.emotionality, _Band.mid), [
    '@{verdict:attractiveness} 감정성도 비슷한 자리에 있어요. 전통 관상은 어느 자리도 유독 튀지 않은 얼굴을 두고 관계가 급하게 오르내리지 않는 상이라 합니다.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.mid, Attribute.emotionality, _Band.low), [
    '@{verdict:emotionality} 매력도는 평균대예요. 전통 관상은 표정의 결이 잔잔한 얼굴을 두고 속을 늦게 내보이는 상이라 했습니다.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.low, Attribute.emotionality, _Band.high), [
    '@{verdict:attractiveness} 대신 감정성은 높은 쪽입니다. 전통 관상은 첫눈보다 오래 볼수록 달라 보이는 상을 따로 두었고, 처첩궁은 시간이 지나며 드러난다고 했어요.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.low, Attribute.emotionality, _Band.mid), [
    '@{verdict:attractiveness} 감정성은 평균대입니다. 전통 관상은 눈에 띄는 자리보다 흐트러지지 않은 자리를 관계에서 더 높게 봅니다.',
  ]),
...
final List<_Frag> _v2RomanceVignette = [
  _Frag(_highOf(Attribute.emotionality), [
    '옛 관상서는 눈에 물기가 도는 얼굴을 두고 정이 오래 간다고 합니다.',
  ]),
  ...
  _Frag.hard((f) => true, [
    ...
    '옛 관상서는 인연을 눈 하나로 보지 않고 눈썹·입·턱을 함께 놓고 읽어 왔어요.',
    '옛 관상서는 처첩궁이 좋아도 명궁이 흐리면 그 자리만으로 읽지 않았어요.',
  ]),
];
...
final List<_Frag> _v2RomanceStrengthFemale = [
  ...
  _Frag.hard((f) => f.bandOf(Attribute.emotionality) == _Band.high, [
    '감정성 항목의 값이 높게 측정됩니다. 관상서는 눈의 기운이 센 얼굴을 두고 상대의 기색을 먼저 알아본다고 했어요.',
  ]),
  ...
  _Frag.hard((f) => true, [
    '관상서는 인연을 눈·눈썹·입·턱 네 자리로 나누어 보았습니다. 이 얼굴은 그 가운데 여러 자리가 평균 부근에 고르게 놓여 있어요.',
    '옛 관상서는 처첩궁이 크게 두드러진 얼굴보다 네 자리가 고른 얼굴을 관계에서 더 좋게 봤어요.',
...
final List<_Frag> _v2RomanceStrengthMale = [
  ...
  _Frag.hard((f) => true, [
    ...
    '옛 관상서는 한 자리가 유독 튀는 얼굴보다 네 자리가 고른 얼굴을 관계에서 더 좋게 봤어요.',
...
final List<_Frag> _v2RomanceShadowFemale = [
  ...
  _Frag.hard(
    (f) =>
        ...
        f.bandOf(Attribute.stability) == _Band.high,
    [
      '다만 옛 관상서는 기운이 세면서 눌러 두는 상을 두고, 눌린 것이 한 번에 터지는 때가 있다고 봅니다.',
    ],
  ),
  _Frag.hard(
    (f) =>
        ...
        f.bandOf(Attribute.stability) != _Band.high,
    [
      '다만 전통 관상은 처첩궁이 실하고 노복궁이 얇은 상을 두고, 인연이 잦되 오래 두기 어렵다고 했어요.',
    ],
  ),
  _Frag.hard(
    (f) =>
    ...
    [
      '다만 옛 관상서는 눈의 기운이 센 상을 두고, 없는 기색까지 읽어 스스로를 지치게 한다고 합니다.',
    ],
  ),
  _Frag.hard(
    (f) =>
  ...
  _Frag.hard((f) => true, [
    '다만 전통 관상은 처첩궁 하나만 보고 판단하지 않았습니다. 명궁과 노복궁이 받쳐 주지 않으면 그 자리만으로는 읽지 않았어요.',
    '다만 옛 관상서는 인연을 자리의 모양보다 그때의 기색으로 먼저 보았어요.',
...
final List<_Frag> _v2RomanceShadowMale = [
  _Frag.hard(
    (f) =>
        ...
        f.bandOf(Attribute.stability) != _Band.high,
    [
      '다만 전통 관상은 기운이 세고 턱이 받쳐 주지 않는 상을 두고, 마음이 한자리에 머물기 어렵다고 했어요.',
    ],
  ),
  _Frag.hard(
    (f) =>
  ...
  _Frag.hard(
    (f) =>
        ...
        f.bandOf(Attribute.stability) != _Band.high,
    [
      '다만 전통 관상은 처첩궁이 실하고 노복궁이 얇은 상을 두고, 인연이 잦되 오래 두기 어렵다고 합니다.',
    ],
  ),
  ...
  _Frag.hard(
    ...
    [
      '다만 전통 관상은 지키는 힘은 세고 나서는 자리가 좁은 상을 두고, 좋은 인연이 곁을 지나가기 쉽다고 했어요.',
    ],
  ),
  _Frag.hard((f) => true, [
    '다만 전통 관상은 처첩궁 하나만 보고 판단하지 않았어요. 명궁과 노복궁이 받쳐 주지 않으면 그 자리만으로는 읽지 않았습니다.',
    '다만 옛 관상서는 인연을 자리의 모양보다 그때의 기색으로 먼저 봤어요.',
    '다만 전통 관상은 상은 마음에서 나온다 하여, 인연의 자리도 고정된 것으로 보지 않았어요.',
  ]),
];

final List<_Frag> _v2RomanceAdvice = [
  _Frag(_highPair(Attribute.attractiveness, Attribute.emotionality), [
    '전통 관상은 처첩궁이 실한 상에 시작보다 지키는 쪽을 권합니다. 만나는 수를 늘리는 것보다 한 관계에 들이는 시간을 늘리는 편이 낫습니다.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.high, Attribute.emotionality, _Band.mid), [
    '전통 관상은 인연이 늦지 않은 상에 서두르지 말라 했습니다. 상대를 고르는 기준을 미리 적어 두면 그 조언이 실제로 작동합니다.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.high, Attribute.emotionality, _Band.low), [
    '전통 관상은 다가오기는 쉬워도 가까워지기는 더딘 상에 먼저 말을 꺼내라 했어요. 표정보다 말이 빠른 통로입니다.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.mid, Attribute.emotionality, _Band.high), [
    '전통 관상은 정을 깊게 쓰는 상에 자기 몫을 남겨 두라 합니다. 상대의 기색을 읽는 만큼 자기 상태도 적어 두세요.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.mid, Attribute.emotionality, _Band.mid), [
    '전통 관상은 치우치지 않은 상을 두고 시간이 쌓이는 만큼 드러난다고 했습니다. 짧게 여럿을 보는 것보다 길게 겪는 자리가 이 구성에 맞습니다.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.mid, Attribute.emotionality, _Band.low), [
    '전통 관상은 속을 늦게 내보이는 상에 말로 옮기는 연습을 권했어요. 상대는 표정만으로 알아채지 못합니다.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.low, Attribute.emotionality, _Band.high), [
    '전통 관상은 오래 볼수록 달라 보이는 상을 따로 두었습니다. 한 번에 결정되는 자리보다 여러 번 마주치는 자리에서 값이 올라갑니다.',
  ]),
  _Frag(_bandPair(Attribute.attractiveness, _Band.low, Attribute.emotionality, _Band.mid), [
    '전통 관상은 눈에 띄는 자리보다 흐트러지지 않은 자리를 관계에서 더 높게 봅니다. 꾸준히 나가는 모임 하나가 가장 크게 작동합니다.',
  ]),
  _Frag(_lowPair(Attribute.attractiveness, Attribute.emotionality), [
    '전통 관상은 열두 자리 가운데 실한 곳을 찾아 그 자리를 쓰라고 합니다. 처첩궁이 아니라면 형제궁 쪽, 곧 곁에 오래 남는 관계부터 넓히는 편이 낫습니다.',
  ]),
  _Frag.hard((f) => true, [
    '전통 관상은 인연을 눈·눈썹·입·턱 네 자리로 나누어 보았어요. 어느 자리가 실한지에 맞춰 만나는 방식을 고르는 편이 낫습니다.',
    ...
    '전통 관상은 얼굴을 고정된 것으로 보지 않았습니다. 상은 마음에서 나온다는 말이 관상서 안에 함께 적혀 있어요.',
    '전통 관상은 혼사를 사람의 큰 갈림으로 봤어요. 그 앞에서는 평소의 열 배쯤 시간을 들여 겪어 보는 편이 낫습니다.',
  ]),
  _Frag.hard(_isYoung, [
...
final List<_Frag> _v2VitalityOpening = [
  _Frag(_highPair(Attribute.libido, Attribute.sensuality), [
    '@{verdict:libido} 흡인력 항목도 함께 높게 나왔습니다. 전통 관상은 눈을 남녀궁이라 하여 기운이 도는 자리로 보았고, 눈썹과 인중이 함께 뚜렷한 얼굴을 정기가 성한 상으로 읽어 왔어요.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.high, Attribute.sensuality, _Band.mid), [
    '@{verdict:libido} 흡인력은 평균대입니다. 전통 관상은 눈썹이 짙고 인중이 또렷한 얼굴을 기운이 안에서 도는 상이라 했어요.',
  ]),
  ...
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.high), [
    '@{verdict:sensuality} 활력은 평균대예요. 전통 관상은 눈꼬리와 입가의 결이 뚜렷한 얼굴을 사람의 눈이 머무는 상으로 봅니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.mid), [
    '@{verdict:libido} 흡인력도 비슷한 자리에 있습니다. 전통 관상은 어느 자리도 유독 튀지 않은 얼굴을 두고 기운이 고르게 도는 상이라 합니다.',
  ]),
  ...
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.mid), [
    '@{verdict:libido} 흡인력은 평균대예요. 전통 관상은 눈썹과 인중의 결이 옅은 얼굴을 두고 기운을 아껴 쓰는 상이라 했어요.',
  ]),
...
final List<_Frag> _v2VitalityVignette = [
  ...
  _Frag.hard((f) => true, [
    ...
    '옛 관상서는 남녀궁이 성해도 얼굴빛이 흐리면 그 자리만으로 읽지 않았어요.',
  ]),
];
...
final List<_Frag> _v2VitalityStrength = [
  ...
  _Frag(_metMid('mouthCornerAngle'), [
    '입꼬리 항목의 값이 평균대에 있습니다. 관상서는 입꼬리가 평평한 입을 두고 기색을 쉽게 드러내지 않는 상이라 합니다.',
  ]),
  ...
  _Frag(_metLo('lipFullnessRatio'), [
    '입술 두께 항목의 값이 평균 아래에 있습니다. 관상서는 입술이 얇은 얼굴을 두고 말과 정을 아껴 쓰는 상이라 했어요.',
  ]),
  ...
  _Frag(_metLo('eyebrowThickness'), [
    '눈썹 두께 항목의 값이 평균 아래에 있어요. 관상서는 옅은 눈썹을 두고 기운을 안으로 두는 상이라 했어요.',
  ]),
  ...
  _Frag(_metLo('cheekboneWidth'), [
    '광대 폭 항목의 값이 평균 아래에 있어요. 관상서는 광대가 낮은 얼굴을 두고 나서기보다 머무는 상이라 했습니다.',
  ]),
  ...
  _Frag(_metLo('gonialAngle'), [
    '하악각 항목의 값이 평균 아래에 있어요. 관상서는 턱선이 둥근 얼굴을 두고 결이 부드러운 상이라 했습니다.',
  ]),
  _Frag(_metHi('faceAspectRatio'), [
    '얼굴 종횡비 항목의 값이 평균 위에 있습니다. 관상서는 세로로 긴 얼굴을 두고 기운이 위아래로 길게 도는 상이라 했어요.',
  ]),
  ...
  _Frag.hard(_yangStrong, [
    '얼굴 전반의 결이 양 쪽으로 기울어 측정됩니다. 관상서는 양의 결이 강한 얼굴을 두고 밖으로 뻗는 기운이 앞선다고 합니다.',
  ]),
  _Frag.hard(_yinStrong, [
    '얼굴 전반의 결이 음 쪽으로 기울어 측정됩니다. 관상서는 음의 결이 강한 얼굴을 두고 안으로 모으는 기운이 앞선다고 했습니다.',
  ]),
  _Frag.hard(_yyHarmony, [
    '음과 양의 결이 고르게 측정됩니다. 관상서는 두 결이 맞물린 얼굴을 두고 기운이 한쪽으로 쏠리지 않는 상이라 했어요.',
  ]),
  _Frag.hard((f) => f.fired('O-PH1') || f.fired('O-PH2'), [
    '인중 항목의 값이 평균에서 뚜렷하게 벗어나 있습니다. 관상서는 인중을 남녀궁과 이어진 자리로 보아 기운의 성쇠를 여기서 읽어 왔어요.',
  ]),
  _Frag.hard((f) => true, [
    '관상서는 기운을 눈·눈썹·인중·입 네 자리로 나누어 봤어요. 이 얼굴은 그 가운데 여러 자리가 평균 부근에 고르게 놓여 있어요.',
    '옛 관상서는 한 자리가 유독 튀는 얼굴보다 네 자리가 고른 얼굴을 기운에서는 더 좋게 봅니다.',
...
final List<_Frag> _v2VitalityShadowFemale = [
  ...
  _Frag(_bandPair(Attribute.libido, _Band.high, Attribute.sensuality, _Band.low), [
    '다만 옛 관상서는 기운은 성한데 결이 드러나지 않는 상을 두고, 안에서 쌓이는 것이 있다고 보았어요.',
  ]),
  _Frag(_and2(_highOf(Attribute.libido), _lowOf(Attribute.stability)), [
    '다만 전통 관상은 기운이 세고 턱이 받쳐 주지 않는 상을 두고, 쓰는 속도가 채우는 속도를 앞선다고 했어요.',
  ]),
  _Frag.hard(
    (f) =>
        f.bandOf(Attribute.libido) == _Band.high &&
  ...
  _Frag.hard(
    ...
    [
      '다만 전통 관상은 세 자리가 함께 잔잔한 상을 두고, 기운을 아껴 두었다가 늦게 쓰는 상이라 했어요.',
    ],
  ),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.low), [
    '다만 옛 관상서는 기운은 고른데 결이 옅은 상을 두고, 먼저 다가가지 않으면 지나친다고 합니다.',
  ]),
  _Frag(_highPair(Attribute.sensuality, Attribute.emotionality), [
    '다만 전통 관상은 결과 정이 함께 깊은 상을 두고, 마음을 먼저 열어 자기가 지치기 쉽다고 했습니다.',
  ]),
  _Frag.hard((f) => f.fired('O-PH1') || f.fired('O-PH2'), [
    '다만 옛 관상서는 인중이 평균에서 크게 벗어난 상을 두고, 기운의 오르내림이 잦다고 봤어요.',
  ]),
  _Frag(_lowOf(Attribute.libido), [
    '다만 전통 관상은 기운이 잔잔한 상을 낮게 보지 않았고, 다만 몸을 돌보는 일이 뒤로 밀리기 쉽다고 했어요.',
  ]),
  _Frag.hard((f) => true, [
    '다만 전통 관상은 남녀궁 하나만 보고 판단하지 않았습니다. 명궁과 질액궁이 받쳐 주지 않으면 그 자리만으로는 읽지 않았어요.',
    '다만 옛 관상서는 기운을 자리의 모양보다 그날의 빛으로 먼저 봅니다.',
...
final List<_Frag> _v2VitalityShadowMale = [
  _Frag(_highPair(Attribute.libido, Attribute.sensuality), [
    '다만 전통 관상은 기운과 결이 함께 성한 상을 두고, 밖으로 도는 만큼 안이 비기 쉽다고 합니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.high, Attribute.sensuality, _Band.low), [
    '다만 옛 관상서는 기운은 성한데 결이 드러나지 않는 상을 두고, 안에서 쌓이는 것이 있다고 보았어요.',
  ]),
  ...
  _Frag(_highPair(Attribute.libido, Attribute.stability), [
    '다만 전통 관상은 기운이 세면서 눌러 두는 상을 두고, 눌린 것이 한 번에 터지는 때가 있다고 했어요.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.high), [
    '다만 옛 관상서는 결은 뚜렷한데 기운이 잔잔한 상을 두고, 밖에서 보는 것과 안이 다르다고 합니다.',
  ]),
  _Frag.hard(
    (f) =>
        f.bandOf(Attribute.libido) == _Band.low &&
  ...
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.low), [
    '다만 옛 관상서는 기운은 고른데 결이 옅은 상을 두고, 먼저 다가가지 않으면 지나친다고 했어요.',
  ]),
  _Frag(_highPair(Attribute.sensuality, Attribute.emotionality), [
    '다만 전통 관상은 결과 정이 함께 깊은 상을 두고, 마음을 먼저 열어 자기가 지치기 쉽다고 합니다.',
  ]),
  _Frag.hard((f) => f.fired('O-PH1') || f.fired('O-PH2'), [
    '다만 옛 관상서는 인중이 평균에서 크게 벗어난 상을 두고, 기운의 오르내림이 잦다고 봤어요.',
  ]),
  _Frag.hard((f) => true, [
    '다만 전통 관상은 남녀궁 하나만 보고 판단하지 않았어요. 명궁과 질액궁이 받쳐 주지 않으면 그 자리만으로는 읽지 않았습니다.',
    '다만 옛 관상서는 기운을 자리의 모양보다 그날의 빛으로 먼저 봅니다.',
    '다만 전통 관상은 상은 마음에서 나온다 하여, 기운의 자리도 고정된 것으로 보지 않았어요.',
  ]),
];
...
final List<_Frag> _v2VitalityAdvice = [
  ...
  _Frag.hard(
    ...
    [
      '전통 관상은 안에서 도는 기운이 센 상에 내보내는 통로를 두라 했어요. 몸을 쓰는 일과가 그 통로 역할을 합니다.',
    ],
  ),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.high), [
    '전통 관상은 결이 뚜렷한 상에 스스로의 상태를 먼저 살피라 합니다. 밖에서 보이는 것과 안이 다를 수 있습니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.mid), [
    '전통 관상은 치우치지 않은 상을 두고 생활이 그대로 기운에 나타난다고 했습니다. 수면 시각을 고정하는 것이 가장 단순한 유지법입니다.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.mid, Attribute.sensuality, _Band.low), [
    '전통 관상은 결이 옅은 상에 먼저 다가가는 쪽을 권했어요. 기다리면 지나가는 자리가 있어요.',
  ]),
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.high), [
  ...
  _Frag.hard(
    (f) =>
        ...
        f.bandOf(Attribute.emotionality) != _Band.low,
    [
      '전통 관상은 기운과 결은 잔잔한데 정이 깊은 상을 따로 둡니다. 사람을 오래 겪는 자리에서 값이 올라갑니다.',
    ],
  ),
  _Frag.hard(
    (f) =>
        ...
        f.bandOf(Attribute.emotionality) == _Band.low,
    [
      '전통 관상은 세 자리가 함께 잔잔한 상을 낮게 보지 않았습니다. 몸을 먼저 채우면 나머지가 따라온다고 했어요.',
    ],
  ),
  _Frag.hard((f) => true, [
    '전통 관상은 기운을 눈·눈썹·인중·입 네 자리로 나누어 보았어요. 어느 자리가 실한지에 맞춰 쓰는 곳을 고르는 편이 낫습니다.',
    '옛 관상서는 기운이 성해도 생활이 어지러우면 그 자리가 흐려진다고 합니다. 수면이 가장 크게 작동합니다.',
    '전통 관상은 얼굴을 고정된 것으로 보지 않았어요. 상은 마음에서 나온다는 말이 관상서 안에 함께 적혀 있습니다.',
  ]),
  _Frag.hard(_isMid, [
...
final List<_Frag> _v2SocialOpening = [
  ...
  _Frag(_bandPair(Attribute.sociability, _Band.high, Attribute.trustworthiness, _Band.low), [
    '@{verdict:sociability} 신뢰성은 낮은 쪽이에요. 전통 관상은 말이 앞서고 이마가 받쳐 주지 않는 상을 따로 두었습니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.mid, Attribute.trustworthiness, _Band.high), [
    '@{verdict:trustworthiness} 사회성은 평균대입니다. 전통 관상은 이마를 관록궁이라 하여 이름이 서는 자리로 보았고, 이 자리가 곧은 얼굴을 말과 행동이 어긋나지 않는 상으로 읽었어요.',
  ]),
  ...
  _Frag(_bandPair(Attribute.sociability, _Band.mid, Attribute.trustworthiness, _Band.low), [
    '@{verdict:trustworthiness} 사회성은 평균대입니다. 전통 관상은 이마가 좁은 얼굴을 두고 말이 자리를 늦게 얻는 상이라 합니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.low, Attribute.trustworthiness, _Band.high), [
    '@{verdict:sociability} 대신 신뢰성은 높은 쪽이에요. 전통 관상은 말수가 적고 이마가 곧은 얼굴을 두고 적게 말하되 그 말이 남는 상이라 했습니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.low, Attribute.trustworthiness, _Band.mid), [
    '@{verdict:sociability} 신뢰성은 평균대입니다. 전통 관상은 넓게 트는 자리보다 깊게 두는 자리를 따로 봤어요.',
  ]),
  _Frag(_lowPair(Attribute.sociability, Attribute.trustworthiness), [
    '@{verdict:sociability} 신뢰성도 함께 아래쪽입니다. 전통 관상은 열두 자리 가운데 어디가 실한지를 보았지 총합을 매기지 않았고, 이 얼굴은 출납관보다 다른 자리에 무게가 실린 상이에요.',
  ]),
  _Frag.hard((f) => true, [
...
final List<_Frag> _v2SocialVignette = [
  _Frag(_highOf(Attribute.trustworthiness), [
    '옛 관상서는 이마가 곧은 얼굴을 두고 말이 뒤집히지 않는다고 했어요.',
  ]),
  _Frag(_highOf(Attribute.emotionality), [
    '옛 관상서는 눈에 기운이 실린 얼굴을 두고 상대의 기색을 먼저 알아본다고 보았어요.',
  ]),
  _Frag(_highOf(Attribute.stability), [
  ...
  _Frag(_highOf(Attribute.sociability), [
    '옛 관상서는 입이 큰 얼굴을 두고 사람이 모여드는 상으로 읽어 왔어요.',
  ]),
  _Frag.hard((f) => true, [
...
final List<_Frag> _v2SocialStrength = [
  ...
  _Frag.hard((f) => f.fired('L-SN'), [
    '코끝 항목의 값이 평균에서 벗어나 있어요. 관상서는 코끝이 들린 얼굴을 두고 먼저 말을 꺼내는 상이라 했어요.',
  ]),
  ...
  _Frag.hard((f) => true, [
    '관상서는 사람됨을 이마·눈썹·눈·입 네 자리로 나누어 봅니다. 이 얼굴은 그 가운데 여러 자리가 평균 부근에 고르게 놓여 있습니다.',
    '옛 관상서는 한 자리가 유독 튀는 얼굴보다 네 자리가 고른 얼굴을 관계에서 더 좋게 보았어요.',
...
final List<_Frag> _v2SocialShadow = [
  ...
  _Frag(_bandPair(Attribute.sociability, _Band.high, Attribute.trustworthiness, _Band.low), [
    '다만 전통 관상은 말이 앞서고 이마가 받쳐 주지 않는 상을 두고, 한 말을 지키는 일이 뒤로 밀린다고 했어요.',
  ]),
  _Frag(_highOf(Attribute.emotionality), [
    '다만 옛 관상서는 눈의 기운이 센 얼굴을 두고, 없는 기색까지 읽어 스스로를 지치게 한다고 합니다.',
  ]),
  _Frag.hard((f) => true, [
    '다만 전통 관상은 출납관 하나만 보고 판단하지 않았어요. 관록궁과 형제궁이 받쳐 주지 않으면 그 자리만으로는 읽지 않았습니다.',
...
final List<_Frag> _v2SocialAdvice = [
  ...
  _Frag(_bandPair(Attribute.sociability, _Band.high, Attribute.trustworthiness, _Band.mid), [
    '전통 관상은 사람이 모이는 상에 한 말을 지키는 쪽을 권했어요. 약속한 것을 적어 두는 습관 하나가 가장 크게 작동합니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.high, Attribute.trustworthiness, _Band.low), [
    '전통 관상은 말이 앞서는 상에 먼저 듣고 뒤에 말하라 합니다. 자리에서 말하는 양을 절반으로 줄이는 것만으로 달라집니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.mid, Attribute.trustworthiness, _Band.high), [
    '전통 관상은 이마가 곧은 상에 자기 이름을 걸 자리를 고르라 했습니다. 여러 자리보다 한 자리에서 오래 쌓는 편이 맞습니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.mid, Attribute.trustworthiness, _Band.mid), [
    '전통 관상은 치우치지 않은 상을 두고 시간이 쌓이는 만큼 드러난다고 했어요. 꾸준히 나가는 모임 하나가 가장 크게 작동합니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.mid, Attribute.trustworthiness, _Band.low), [
    '전통 관상은 이름이 늦게 서는 상에 작은 약속부터 지키라 합니다. 큰 말보다 지킨 횟수가 자리를 만듭니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.low, Attribute.trustworthiness, _Band.high), [
    '전통 관상은 적게 말하되 그 말이 남는 상을 따로 두었어요. 넓히려 애쓰기보다 몇 사람에게 깊게 두는 편이 맞습니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.low, Attribute.trustworthiness, _Band.mid), [
    '전통 관상은 깊게 두는 자리를 넓게 트는 자리와 나누어 봤어요. 사람 수보다 겪는 시간을 기준으로 삼으세요.',
  ]),
  _Frag(_lowPair(Attribute.sociability, Attribute.trustworthiness), [
    '전통 관상은 열두 자리 가운데 실한 곳을 찾아 그 자리를 쓰라고 했습니다. 출납관이 아니라면 일이나 재능으로 먼저 알려지는 쪽이 낫습니다.',
  ]),
  _Frag.hard((f) => true, [
    '전통 관상은 사람됨을 이마·눈썹·눈·입 네 자리로 나누어 봅니다. 어느 자리가 실한지에 맞춰 관계를 넓히는 방식을 고르는 편이 낫습니다.',
    '옛 관상서는 출납관이 좋아도 마음이 흐트러지면 그 자리가 흐려진다고 했어요. 관계에서 먼저 손볼 것은 상대가 아니라 자기 상태예요.',
    '전통 관상은 말의 많고 적음보다 지켜지는지를 먼저 보았어요. 약속의 크기를 줄이고 지킨 횟수를 늘리는 쪽이 맞습니다.',
    '전통 관상은 얼굴을 고정된 것으로 보지 않았습니다. 상은 마음에서 나온다는 말이 관상서 안에 함께 적혀 있어요.',
...
final List<_Frag> _v2TalentOpening = [
  _Frag(_highPair(Attribute.intelligence, Attribute.leadership), [
    '@{verdict:intelligence} 리더십 항목도 함께 높게 나왔습니다. 전통 관상은 이마를 관록궁이라 하여 이름과 자리가 서는 곳으로 보았고, 이 자리가 넓으면서 턱이 받쳐 주는 얼굴을 앞에 서는 상으로 읽었어요.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.high, Attribute.leadership, _Band.mid), [
    '@{verdict:intelligence} 리더십은 평균대입니다. 전통 관상은 이마가 넓고 반듯한 얼굴을 두고 먼저 헤아리는 상이라 합니다.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.high, Attribute.leadership, _Band.low), [
    '@{verdict:intelligence} 리더십은 낮은 쪽이에요. 전통 관상은 이마는 서고 턱이 얇은 상을 두고, 헤아리기는 하되 앞에 나서지는 않는다고 했습니다.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.mid, Attribute.leadership, _Band.high), [
    '@{verdict:leadership} 통찰력은 평균대입니다. 전통 관상은 턱과 광대가 함께 선 얼굴을 두고 사람을 이끄는 힘이 실린 상이라 했어요.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.mid, Attribute.leadership, _Band.mid), [
    '@{verdict:intelligence} 리더십도 비슷한 자리에 있습니다. 전통 관상은 어느 자리도 유독 튀지 않은 얼굴을 두고 재주가 한쪽으로 몰리지 않은 상이라 합니다.',
  ...
  _Frag(_bandPair(Attribute.intelligence, _Band.low, Attribute.leadership, _Band.high), [
    '@{verdict:intelligence} 대신 리더십은 높은 쪽이에요. 전통 관상은 헤아리는 자리와 이끄는 자리를 나누어 보았고, 이 얼굴은 뒤쪽에 무게가 실려 있어요.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.low, Attribute.leadership, _Band.mid), [
    '@{verdict:intelligence} 리더십은 평균대입니다. 전통 관상은 이마보다 아래 자리가 발달한 얼굴을 두고 머리보다 손과 발이 앞서는 상이라 했어요.',
  ]),
  _Frag(_lowPair(Attribute.intelligence, Attribute.leadership), [
    '@{verdict:intelligence} 리더십도 함께 아래쪽입니다. 전통 관상은 열두 자리 가운데 어디가 실한지를 보았지 총합을 매기지 않았고, 이 얼굴은 관록궁보다 다른 자리에 무게가 실린 상이에요.',
  ]),
  _Frag.hard((f) => true, [
...
final List<_Frag> _v2TalentVignette = [
  _Frag(_highOf(Attribute.intelligence), [
    '옛 관상서는 이마가 넓고 반듯한 얼굴을 두고 배운 것이 오래 남는다고 합니다.',
  ]),
  _Frag(_highOf(Attribute.leadership), [
    '옛 관상서는 턱과 광대가 함께 선 얼굴을 두고 사람이 따르는 상이라 보았어요.',
  ]),
  _Frag.hard(
    (f) =>
  ...
  _Frag(_lowOf(Attribute.stability), [
    '옛 관상서는 턱이 얇은 얼굴을 두고 시작한 것을 끝까지 두기 어렵다고 했어요.',
  ]),
  _Frag.hard((f) => true, [
    '관상에서 이마는 관록궁이면서 천이궁이기도 합니다. 이름과 자리 옮김을 같은 곳에서 읽었다는 뜻입니다.',
    '옛 관상서는 재주를 이마 하나로 보지 않고 눈썹·눈·턱을 함께 놓고 읽어 왔어요.',
...
final List<_Frag> _v2TalentStrength = [
  ...
  _Frag.hard((f) => f.fired('O-FB'), [
    '이마와 눈썹 항목이 함께 높게 측정됩니다. 관상서는 두 자리가 같이 선 얼굴을 두고 뜻과 배움이 한 방향으로 간다고 봅니다.',
  ]),
  ...
  _Frag.hard((f) => true, [
    '관상서는 재주를 이마·눈썹·눈·턱 네 자리로 나누어 보았어요. 이 얼굴은 그 가운데 여러 자리가 평균 부근에 고르게 놓여 있어요.',
...
final List<_Frag> _v2TalentShadow = [
  ...
  _Frag.hard(
    (f) =>
        ...
        f.bandOf(Attribute.leadership) == _Band.low,
    [
      '다만 옛 관상서는 이마는 서고 턱이 얇은 상을 두고, 아는 것이 자리로 이어지기까지 시간이 걸린다고 합니다.',
    ],
  ),
  _Frag.hard(
    (f) =>
  ...
  _Frag(_lowOf(Attribute.stability), [
    '다만 옛 관상서는 턱이 얇은 상을 두고 시작한 것을 끝까지 두기 어렵다고 했어요.',
  ]),
  _Frag.hard(
    (f) =>
        f.bandOf(Attribute.emotionality) == _Band.high &&
        f.bandOf(Attribute.stability) != _Band.high,
    [
      '다만 전통 관상은 눈의 기운이 세고 턱이 받쳐 주지 않는 상을 두고, 마음이 일보다 먼저 움직인다고 합니다.',
    ],
  ),
  _Frag.hard((f) => true, [
    '다만 전통 관상은 관록궁 하나만 보고 판단하지 않았습니다. 명궁과 노복궁이 받쳐 주지 않으면 그 자리만으로는 읽지 않았어요.',
    '다만 옛 관상서는 타고난 바탕보다 그것을 쓰는 결을 먼저 봤어요.',
...
final List<_Frag> _v2TalentAdvice = [
  ...
  _Frag(_bandPair(Attribute.intelligence, _Band.high, Attribute.leadership, _Band.mid), [
    '전통 관상은 이마가 선 상에 깊게 파는 쪽을 권했어요. 여러 갈래보다 한 갈래에서 오래 쌓는 편이 맞습니다.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.high, Attribute.leadership, _Band.low), [
    '전통 관상은 아는 것이 자리로 늦게 이어지는 상에 밖으로 내보이라 합니다. 쌓은 것을 글이나 말로 정리해 두는 일이 그에 해당합니다.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.mid, Attribute.leadership, _Band.high), [
    '전통 관상은 이끄는 힘이 앞선 상에 먼저 듣고 뒤에 정하라 했습니다. 결정 전에 반대 의견을 하나 이상 듣는 규칙이 그 역할을 합니다.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.mid, Attribute.leadership, _Band.mid), [
    '전통 관상은 치우치지 않은 상을 두고 무엇을 잡느냐가 그대로 드러난다고 했어요. 한 분야를 3년 단위로 잡아 두세요.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.mid, Attribute.leadership, _Band.low), [
    '전통 관상은 뒤에서 받치는 자리가 맞는 상을 따로 둡니다. 앞에 서는 자리를 억지로 잡기보다 대체 불가한 기술을 하나 두는 편이 낫습니다.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.low, Attribute.leadership, _Band.high), [
    '전통 관상은 먼저 움직이는 상에 사람을 두라 합니다. 헤아리는 사람을 곁에 두면 그 자리가 채워집니다.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.low, Attribute.leadership, _Band.mid), [
    '전통 관상은 머리보다 손과 발이 앞서는 상을 두고 몸으로 익히는 쪽을 권했습니다. 책보다 현장에서 값이 올라갑니다.',
  ]),
  _Frag(_lowPair(Attribute.intelligence, Attribute.leadership), [
    '전통 관상은 열두 자리 가운데 실한 곳을 찾아 그 자리를 쓰라고 했어요. 관록궁이 아니라면 손재주나 관계 쪽을 중심에 두는 편이 낫습니다.',
  ]),
  _Frag.hard((f) => true, [
    '전통 관상은 재주를 이마·눈썹·눈·턱 네 자리로 나누어 봅니다. 어느 자리가 실한지에 맞춰 일을 고르는 편이 낫습니다.',
    '옛 관상서는 바탕보다 그것을 쓰는 결을 먼저 보았어요. 무엇을 아느냐보다 무엇에 오래 매달렸느냐가 남습니다.',
    '전통 관상은 얼굴을 고정된 것으로 보지 않았어요. 상은 마음에서 나온다는 말이 관상서 안에 함께 적혀 있습니다.',
...
final List<_Frag> _v2ConcludeStage = [
  _Frag.hard((f) => f.age.isOver50, [
    '전통 관상은 미간을 명궁이라 하여 열두 자리 가운데 가장 먼저이자 마지막에 보는 곳으로 두었습니다. 지금 구간에서는 쌓는 일보다 남길 것과 흘려보낼 것을 가르는 판단이 중심에 놓이에요.',
  ]),
  ...
  _Frag.hard((f) => !f.age.isOver20, [
    '전통 관상은 어린 얼굴을 두고 아직 자리가 굳지 않았다고 봤어요. 지금 구간에서는 겪는 폭이 그대로 다음 구간의 깊이가 됩니다.',
  ]),
];
