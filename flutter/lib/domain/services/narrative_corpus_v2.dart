...
final List<_Frag> _v2WealthStrength = [
  ...
  _Frag.hard((f) => f.fired('O-CK') || f.nodeZ('cheekbone') >= 0.8, [
    '광대 항목의 값이 평균 위에 있어요. 관상에서 광대는 오악의 하나이고, 이 자리가 선 얼굴을 사람을 움직이는 힘이 있는 상이라 했습니다.',
  ]),
  ...
  _Frag.hard((f) => f.fired('O-NM1') || f.fired('O-NM2'), [
    '코와 입 항목의 값이 함께 높습니다. 관상에서는 코를 재백궁, 입을 출납관이라 하여 들어오는 자리와 나가는 자리로 나누어 보았어요.',
  ]),
  _Frag.hard((f) => true, [
...
final List<_Frag> _v2WealthShadow = [
  _Frag(_highPair(Attribute.wealth, Attribute.stability), [
    '다만 관상 전통은 코와 턱이 모두 두터운 얼굴을 두고, 쥐는 힘이 세어 내놓는 자리가 좁아지기 쉽다고도 했습니다.',
  ]),
  _Frag(_lowOf(Attribute.wealth), [
  ...
  _Frag.hard((f) => true, [
    ...
    '다만 관상 전통은 한 자리가 유독 두드러진 얼굴보다 여러 자리가 고른 얼굴을 높게 봤어요.',
    '다만 옛 관상 문헌은 상은 마음에서 나온다 하여, 얼굴을 고정된 것으로 보지 않았어요.',
  ]),
];
...
final List<_Frag> _v2WealthAdvice = [
  ...
  _Frag.hard((f) => true, [
    ...
    '관상 전통은 재백궁이 실해도 마음이 흐트러지면 그 자리가 무너진다고 했습니다. 감정이 올라온 구간의 결정을 미루는 규칙이 그에 해당합니다.',
    '관상 전통은 한 번에 크게 얻는 것보다 흐트러지지 않는 쪽을 높게 보았어요. 큰 베팅 한 번보다 매달 도는 고정 저축이 그 방향이에요.',
    '예로부터 관상에서는 얼굴을 고정된 것으로 보지 않았습니다. 상은 마음에서 나온다는 말이 관상 문헌 안에 함께 적혀 있습니다.',
...
final List<_Frag> _v2HealthOpening = [
  _Frag(_highPair(Attribute.stability, Attribute.emotionality), [
    '@{verdict:stability} 감정성 항목도 함께 높게 나왔습니다. 관상 전통은 코를 질액궁이라 하여 몸의 자리로도 봅니다. 산근이 곧으면서 눈에 물기가 도는 얼굴은 기운이 살아 있는 상으로 읽어요.',
  ]),
...
final List<_Frag> _v2HealthStrength = [
  _Frag.hard((f) => f.fired('P-07') || f.nodeAZ('nose') >= 1.2, [
    '코 항목의 측정값이 같은 성별·얼굴형 평균에서 뚜렷하게 벗어나 있어요. 관상에서는 이 자리를 질액궁이라 하고, 산근이 곧게 선 얼굴을 몸의 기운이 막히지 않는 상으로 읽습니다.',
  ]),
  _Frag.hard((f) => f.fired('Z-09'), [
    '눈 주변 항목의 값이 높게 측정됩니다. 관상에서 눈은 사독 가운데 하(河)이고, 이 자리를 기운이 흐르는 통로로 봤어요.',
  ]),
  ...
  _Frag.hard((f) => true, [
    ...
    '관상 전통은 한 자리가 유독 튀는 얼굴보다 네 자리가 고른 얼굴을 몸에서는 더 좋게 보았어요.',
    '옛 관상 문헌에서는 얼굴빛을 자리의 모양보다 먼저 보았습니다. 모양은 타고나지만 빛은 그때그때 달라진다고 여겼기 때문이에요.',
    '관상에서 미간은 명궁, 코는 질액궁입니다. 두 자리가 함께 트여 있으면 기운이 위아래로 통하는 상으로 읽었습니다.',
...
final List<_Frag> _v2HealthAdvice = [
  _Frag(_highPair(Attribute.stability, Attribute.emotionality), [
    '관상 전통은 기운이 센 상에 오히려 덜어내는 쪽을 권합니다. 버틸 수 있다는 감각이 회복 시점을 늦추니, 피로를 느낀 날짜를 적어 두는 정도면 충분합니다.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.high, Attribute.emotionality, _Band.mid), [
  ...
  _Frag(_bandPair(Attribute.stability, _Band.low, Attribute.emotionality, _Band.high), [
    '관상 전통은 산근이 얕고 기운이 센 상에 무리를 짧게 끊으라 합니다. 몰아서 쉬는 것보다 매일 조금씩 끊어 쉬는 쪽이 이 조언에 맞습니다.',
  ]),
  _Frag(_bandPair(Attribute.stability, _Band.low, Attribute.emotionality, _Band.mid), [
  ...
  _Frag.hard((f) => true, [
    ...
    '옛 관상 문헌은 상은 마음에서 나온다고 했습니다. 몸의 자리도 생활에 따라 달라진다고 본 것이고, 수면이 그 가운데 가장 크게 작동합니다.',
...
final List<_Frag> _v2RomanceOpening = [
  ...
  _Frag(_bandPair(Attribute.attractiveness, _Band.mid, Attribute.emotionality, _Band.high), [
    '@{verdict:emotionality} 매력도는 평균대입니다. 관상 전통은 눈을 사독 가운데 하(河)라 하여 정이 흐르는 자리로 보았고, 이 자리가 강한 얼굴을 마음을 깊게 쓰는 상이라 했어요.',
  ]),
...
final List<_Frag> _v2RomanceVignette = [
  ...
  _Frag(_highOf(Attribute.stability), [
    '관상에서는 턱이 두터운 얼굴을 두고 한 사람 곁에 오래 머문다고 했습니다.',
  ]),
  _Frag.hard((f) => true, [
    '관상에서 눈은 처첩궁이면서 전택궁이기도 합니다. 짝과 사는 자리를 같은 곳에서 읽었다는 뜻입니다.',
    '관상 전통은 인연을 눈 하나로 보지 않고 눈썹·입·턱을 함께 놓고 읽어 왔어요.',
...
final List<_Frag> _v2RomanceStrengthFemale = [
  ...
  _Frag.hard((f) => f.nodeZ('eye') >= 0.5, [
    '눈 항목의 값이 평균 위에 있습니다. 관상에서는 눈을 감찰관이라 하여 살피고 가려내는 자리로도 보았어요.',
  ]),
  _Frag.hard((f) => true, [
    ...
    '관상에서 눈썹은 형제궁입니다. 이 자리가 고른 얼굴을 곁에 사람이 남는 상으로 읽습니다.',
  ]),
];
...
final List<_Frag> _v2RomanceStrengthMale = [
  ...
  _Frag.hard((f) => f.bandOf(Attribute.trustworthiness) == _Band.high, [
    '신뢰성 항목의 값이 높은 쪽입니다. 관상에서는 이마와 눈이 함께 곧은 얼굴을 말과 행동이 어긋나지 않는 상으로 봅니다.',
  ]),
  ...
  _Frag.hard((f) => f.nodeZ('chin') >= 0.5, [
    '턱 항목의 값이 평균 위에 있어요. 관상에서 턱은 노복궁이고, 이 자리가 두터운 얼굴을 한자리에 오래 머무는 상으로 읽었어요.',
  ]),
  _Frag.hard((f) => true, [
    '관상 전통은 인연을 눈·눈썹·코·턱 네 자리로 나누어 보았습니다. 이 얼굴은 그 가운데 여러 자리가 평균 부근에 고르게 놓여 있습니다.',
...
final List<_Frag> _v2RomanceShadowFemale = [
  ...
  _Frag.hard((f) => true, [
    '다만 관상 전통은 처첩궁 하나만 보고 판단하지 않았습니다. 명궁과 노복궁이 받쳐 주지 않으면 그 자리만으로는 읽지 않았어요.',
    '다만 관상 전통은 인연을 자리의 모양보다 그때의 기색으로 먼저 보았어요.',
...
final List<_Frag> _v2RomanceAdvice = [
  ...
  _Frag(_bandPair(Attribute.attractiveness, _Band.low, Attribute.emotionality, _Band.mid), [
    '관상 전통은 눈에 띄는 자리보다 흐트러지지 않은 자리를 관계에서 더 높게 봅니다. 꾸준히 나가는 모임 하나가 가장 크게 작동합니다.',
  ]),
  _Frag(_lowPair(Attribute.attractiveness, Attribute.emotionality), [
    '관상 전통은 열두 자리 가운데 실한 곳을 찾아 그 자리를 쓰라고 합니다. 처첩궁이 아니라면 형제궁 쪽, 곧 곁에 오래 남는 관계부터 넓히는 편이 낫습니다.',
  ]),
  _Frag.hard((f) => true, [
    ...
    '전통 관상학에서는 얼굴을 고정된 것으로 보지 않았습니다. 상은 마음에서 나온다는 말이 관상 문헌 안에 함께 적혀 있어요.',
...
final List<_Frag> _v2VitalityVignette = [
  ...
  _Frag.hard((f) => true, [
    ...
    '관상 전통은 남녀궁이 성해도 얼굴빛이 흐리면 그 자리만으로 읽지 않았어요.',
  ]),
];
...
final List<_Frag> _v2VitalityStrength = [
  ...
  _Frag(_metLo('mouthCornerAngle'), [
    '입꼬리 항목의 값이 평균 아래에 있어요. 관상에서는 입꼬리가 내려간 입을 부월구라 하여 안으로 눌러 두는 상으로 봤어요.',
  ]),
  ...
  _Frag(_metLo('upperVsLowerLipRatio'), [
    '아랫입술이 윗입술보다 두툼하게 측정됩니다. 관상에서는 이런 입을 두고 받는 쪽에 무게가 실린 상이라 했습니다.',
  ]),
  ...
  _Frag(_metHi('eyeAspect'), [
    '눈의 세로 대 가로 비율이 평균 위에 있습니다. 관상에서는 이런 눈을 원안이라 하여 마음이 밖으로 잘 드러나는 상으로 보았습니다.',
  ]),
  ...
  _Frag(_metLo('eyebrowCurvature'), [
    '눈썹 곡률 항목의 값이 평균 아래에 있어요. 관상에서는 곧게 뻗은 눈썹을 직미라 하여 결이 굳은 상으로 봅니다.',
  ]),
  _Frag(_metHi('cheekboneWidth'), [
    '광대 폭 항목의 값이 평균 위에 있습니다. 관상에서 광대는 오악의 하나이고, 이 자리가 선 얼굴을 기운이 밖으로 뻗는 상이라 합니다.',
  ]),
  ...
  _Frag(_metLo('faceAspectRatio'), [
    '얼굴 종횡비 항목의 값이 평균 아래에 있어요. 관상에서는 가로로 넓은 얼굴을 두고 기운이 옆으로 퍼지는 상으로 읽습니다.',
  ]),
  _Frag.hard((f) => f.fired('L-EL'), [
  ...
  _Frag.hard((f) => true, [
    '관상 전통은 기운을 눈·눈썹·인중·입 네 자리로 나누어 봤어요. 이 얼굴은 그 가운데 여러 자리가 평균 부근에 고르게 놓여 있어요.',
    '관상 전통은 한 자리가 유독 튀는 얼굴보다 네 자리가 고른 얼굴을 기운에서는 더 좋게 봅니다.',
...
final List<_Frag> _v2VitalityShadowFemale = [
  ...
  _Frag.hard((f) => true, [
    ...
    '다만 전통 관상학에서는 상은 마음에서 나온다 하여, 기운의 자리도 고정된 것으로 보지 않았습니다.',
  ]),
];
...
final List<_Frag> _v2VitalityShadowMale = [
  ...
  _Frag(_highPair(Attribute.sensuality, Attribute.emotionality), [
    '다만 관상 전통은 결과 정이 함께 깊은 상을 두고, 마음을 먼저 열어 자기가 지치기 쉽다고 합니다.',
  ]),
  _Frag.hard((f) => f.fired('O-PH1') || f.fired('O-PH2'), [
    '다만 인중이 평균에서 크게 벗어난 상을 두고, 전통 관상학에서는 기운의 오르내림이 잦다고 봤어요.',
  ]),
  _Frag.hard((f) => true, [
    '다만 관상 전통은 남녀궁 하나만 보고 판단하지 않았어요. 명궁과 질액궁이 받쳐 주지 않으면 그 자리만으로는 읽지 않았습니다.',
...
final List<_Frag> _v2VitalityAdvice = [
  ...
  _Frag(_bandPair(Attribute.libido, _Band.low, Attribute.sensuality, _Band.mid), [
    '관상 전통은 기운을 아껴 쓰는 상에 쓰는 자리를 정해 두라 했습니다. 무엇에 쓸지 정하지 않으면 아낀 것이 남지 않습니다.',
  ]),
  _Frag.hard(
    (f) =>
        f.bandOf(Attribute.libido) == _Band.low &&
  ...
  _Frag.hard((f) => true, [
    ...
    '전통 관상학에서는 얼굴을 고정된 것으로 보지 않았어요. 상은 마음에서 나온다는 말이 관상 문헌 안에 함께 적혀 있습니다.',
  ]),
  _Frag.hard(_isMid, [
...
final List<_Frag> _v2SocialOpening = [
  _Frag(_highPair(Attribute.sociability, Attribute.trustworthiness), [
    '@{verdict:sociability} 신뢰성 항목도 함께 높게 나왔습니다. 관상 전통은 입을 오관 가운데 출납관이라 하여 말이 드나드는 자리로 보았고, 이 자리가 단정하면서 이마가 곧은 얼굴을 말이 무게를 갖는 상으로 읽었습니다.',
  ]),
...
final List<_Frag> _v2SocialStrength = [
  _Frag.hard((f) => f.fired('O-EM') || f.fired('O-PH2'), [
    '입 주변 항목의 측정값이 평균 위에 있습니다. 관상에서는 이 자리를 출납관이라 하고, 입매가 단정한 얼굴을 말이 새지 않는 상으로 읽었어요.',
  ]),
  _Frag.hard((f) => f.fired('L-AQ'), [
  ...
  _Frag.hard((f) => f.nodeZ('mouth') >= 0.8, [
    '입 항목의 값이 높게 측정됩니다. 관상에서 입은 사독 가운데 제(濟)이고, 이 자리가 큰 얼굴을 사람이 모이는 상으로 읽습니다.',
  ]),
...
final List<_Frag> _v2SocialShadow = [
  ...
  _Frag(_lowPair(Attribute.sociability, Attribute.trustworthiness), [
    '다만 관상 전통은 두 자리가 함께 잔잔한 상을 낮게 보지 않았고, 다만 먼저 다가가지 않으면 지나친다고 했습니다.',
  ]),
  _Frag(_bandPair(Attribute.sociability, _Band.high, Attribute.trustworthiness, _Band.low), [
...
final List<_Frag> _v2SocialAdvice = [
  ...
  _Frag(_bandPair(Attribute.sociability, _Band.low, Attribute.trustworthiness, _Band.mid), [
    '관상 전통은 깊게 두는 자리를 넓게 트는 자리와 나누어 봤어요. 사람 수보다 겪는 시간을 기준으로 삼으세요.',
  ]),
  _Frag(_lowPair(Attribute.sociability, Attribute.trustworthiness), [
  ...
  _Frag.hard((f) => true, [
    ...
    '관상 전통은 말의 많고 적음보다 지켜지는지를 먼저 보았어요. 약속의 크기를 줄이고 지킨 횟수를 늘리는 쪽이 맞습니다.',
    '옛 관상 문헌은 얼굴을 고정된 것으로 보지 않았습니다. 상은 마음에서 나온다는 말이 관상 문헌 안에 함께 적혀 있어요.',
...
final List<_Frag> _v2TalentVignette = [
  ...
  _Frag.hard((f) => true, [
    ...
    '관상 전통은 관록궁이 넓어도 명궁이 흐리면 그 자리만으로 읽지 않았어요.',
  ]),
];

final List<_Frag> _v2TalentStrength = [
  _Frag.hard((f) => f.fired('O-EB1') || f.fired('O-EB2'), [
    '눈썹 항목의 측정값이 평균 위에 있습니다. 관상에서 눈썹은 형제궁이면서 기운의 결을 보는 자리이고, 이 자리가 뚜렷한 얼굴을 뜻이 분명한 상으로 읽었습니다.',
  ]),
  _Frag.hard((f) => f.fired('P-02') || f.nodeZ('forehead') >= 1.0, [
    '이마 항목의 값이 뚜렷하게 높습니다. 관상에서는 이 자리를 관록궁이라 하고, 넓고 반듯한 이마를 배움이 쌓이는 상으로 보았습니다.',
  ]),
  ...
  _Frag.hard((f) => f.nodeAZ('nose') >= 1.0, [
    '코 항목의 값이 평균에서 뚜렷하게 벗어나 있습니다. 관상에서 코는 심변관이고, 이 자리가 두드러진 얼굴을 가려내는 힘이 강한 상으로 읽었어요.',
  ]),
...
final List<_Frag> _v2TalentAdvice = [
  ...
  _Frag(_bandPair(Attribute.intelligence, _Band.high, Attribute.leadership, _Band.mid), [
    '관상 전통은 이마가 선 상에 깊게 파는 쪽을 권했어요. 여러 갈래보다 한 갈래에서 오래 쌓는 편이 맞습니다.',
  ]),
  _Frag(_bandPair(Attribute.intelligence, _Band.high, Attribute.leadership, _Band.low), [
  ...
  _Frag.hard((f) => true, [
    ...
    '관상 전통은 얼굴을 고정된 것으로 보지 않았어요. 상은 마음에서 나온다는 말이 관상 문헌 안에 함께 적혀 있습니다.',
...
final List<_Frag> _v2ConcludeAdvice = [
  _Frag.hard((f) => true, [
    '마지막으로 짚어 둘 게 있어요. 이 리포트는 두 가지만 말합니다. 하나는 얼굴 계측값이 같은 성별·얼굴형 분포 11,800명 가운데 어디에 놓이는지이고, 다른 하나는 전통 관상이 그 자리를 어떻게 읽어 왔는지예요. 앞일을 맞히려 한 것이 아니고, 전통의 해석이 맞다고 주장하지도 않습니다. 전통 관상학에서도 상은 마음에서 나온다 하여 얼굴을 고정된 것으로 보지 않았습니다.',
  ]),
];
