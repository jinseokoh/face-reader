...
final _commonRules = <_InteractionRule>[
  ...
  _InteractionRule('W-R1',
      (s) => s['nasalWidthRatio']! >= 2 && s['nasalHeightRatio']! >= 2,
      {Attribute.wealth: 2.5}),
  _InteractionRule('W-R2',
      (s) => s['nasalWidthRatio']! >= 2 && s['nasalHeightRatio']! <= -2,
      {Attribute.wealth: 0.5}),
  _InteractionRule('W-R3',
      (s) => s['nasalHeightRatio']! >= 2 && s['nasalWidthRatio']!.abs() <= 1,
      {Attribute.wealth: 1.5}),
  _InteractionRule('W-R4',
      (s) => s['nasalWidthRatio']! <= -2 && s['nasalHeightRatio']! <= -2,
      {Attribute.wealth: -2.0}),
  _InteractionRule('W-R5', (s) => s['mouthWidthRatio']! >= 2 && s['nasalWidthRatio']! >= 2,
      {Attribute.wealth: 1.0}),
  _InteractionRule('W-R6',
      (s) => s['mouthWidthRatio']! >= 2 && s['nasalWidthRatio']!.abs() <= 1,
      {Attribute.wealth: 0.5}),

  // Leadership (5)
  _InteractionRule('L-R1', (s) => s['gonialAngle']! >= 2 && s['eyeCanthalTilt']! >= 2,
      {Attribute.leadership: 3.0}),
  _InteractionRule('L-R2', (s) => s['gonialAngle']! >= 2 && s['eyebrowThickness']! >= 2,
      {Attribute.leadership: 2.0}),
  _InteractionRule('L-R3', (s) => s['browEyeDistance']! >= 2 && s['gonialAngle']! >= 0,
      {Attribute.leadership: 1.5}),
  _InteractionRule('L-R4', (s) => s['eyeCanthalTilt']! <= -2 && s['gonialAngle']! <= -2,
      {Attribute.leadership: -2.0}),
  _InteractionRule('L-R5', (s) => s['faceTaperRatio']! <= -2 && s['eyeCanthalTilt']! >= 2,
      {Attribute.leadership: 1.5}),
  _InteractionRule('L-R6',
      (s) => s['gonialAngle']!.abs() <= 1 && s['eyeCanthalTilt']!.abs() <= 1,
      {Attribute.leadership: 1.0}),
  _InteractionRule('L-R7',
      (s) => s['gonialAngle']! >= 2 && s['eyeCanthalTilt']! <= -2,
      {Attribute.leadership: 1.5, Attribute.stability: 0.5}),

  // Intelligence (5)
  _InteractionRule('I-R1', (s) => s['eyeFissureRatio']! >= 2 && s['browEyeDistance']! >= 2,
      {Attribute.intelligence: 3.0}),
  _InteractionRule('I-R2', (s) => s['intercanthalRatio']! <= -2 && s['eyeFissureRatio']! >= 2,
      {Attribute.intelligence: 2.0}),
  _InteractionRule('I-R3',
      (s) => s['browEyeDistance']! >= 2 && s['nasalHeightRatio']! >= 2,
      {Attribute.intelligence: 1.5}),
  _InteractionRule('I-R4', (s) => s['eyeFissureRatio']! <= -2 && s['browEyeDistance']! <= -2,
      {Attribute.intelligence: -1.5}),
  _InteractionRule('I-R5', (s) => s['faceAspectRatio']! >= 2 && s['browEyeDistance']! >= 2,
      {Attribute.intelligence: 1.0}),
  _InteractionRule('I-R6',
      (s) => s['eyeFissureRatio']! >= 2 && s['browEyeDistance']!.abs() <= 1,
      {Attribute.intelligence: 1.0}),

  // Sociability (5)
  _InteractionRule('S-R1', (s) => s['mouthWidthRatio']! >= 2 && s['mouthCornerAngle']! >= 2,
      {Attribute.sociability: 3.0}),
  _InteractionRule('S-R2', (s) => s['mouthCornerAngle']! >= 2 && s['lipFullnessRatio']! >= 2,
      {Attribute.sociability: 2.0}),
  _InteractionRule('S-R3', (s) => s['intercanthalRatio']! >= 2 && s['mouthWidthRatio']! >= 2,
      {Attribute.sociability: 1.5}),
  _InteractionRule('S-R4', (s) => s['mouthCornerAngle']! <= -2 && s['mouthWidthRatio']! <= -2,
      {Attribute.sociability: -2.0}),
  _InteractionRule('S-R5', (s) => s['mouthCornerAngle']! >= 2 && s['eyeFissureRatio']! >= 2,
      {Attribute.sociability: 1.0}),
  _InteractionRule('S-R6',
      (s) => s['mouthWidthRatio']! >= 2 && s['mouthCornerAngle']!.abs() <= 1,
      {Attribute.sociability: 1.0}),

  // Emotionality (5)
  _InteractionRule('E-R1', (s) => s['lipFullnessRatio']! >= 2 && s['eyebrowThickness']! <= -2,
      {Attribute.emotionality: 3.0}),
  _InteractionRule('E-R2', (s) => s['lipFullnessRatio']! >= 2 && s['mouthCornerAngle']! >= 2,
      {Attribute.emotionality: 2.0}),
  _InteractionRule('E-R3', (s) => s['browEyeDistance']! <= -2 && s['lipFullnessRatio']! >= 2,
      {Attribute.emotionality: 2.0}),
  _InteractionRule('E-R4', (s) => s['eyebrowThickness']! >= 2 && s['browEyeDistance']! >= 2,
      {Attribute.emotionality: -2.0}),
  _InteractionRule('E-R5', (s) => s['philtrumLength']! >= 2 && s['lipFullnessRatio']! >= 0,
  ...
  // Sensuality (5)
  _InteractionRule('SN-R1', (s) => s['eyeCanthalTilt']! >= 2 && s['lipFullnessRatio']! >= 2,
      {Attribute.sensuality: 3.0}),
  _InteractionRule('SN-R2', (s) => s['eyeCanthalTilt']! >= 2 && s['eyeFissureRatio']! >= 2,
      {Attribute.sensuality: 2.0}),
  _InteractionRule('SN-R3', (s) => s['mouthCornerAngle']! >= 2 && s['lipFullnessRatio']! >= 2,
      {Attribute.sensuality: 2.0}),
  _InteractionRule('SN-R4', (s) => s['philtrumLength']! <= -2 && s['lipFullnessRatio']! >= 2,
      {Attribute.sensuality: 2.0}),
  _InteractionRule('SN-R5', (s) => s['eyeCanthalTilt']! <= -2 && s['lipFullnessRatio']! <= -2,
      {Attribute.sensuality: -2.0}),
  _InteractionRule('SN-R6',
      (s) => s['eyeCanthalTilt']! >= 2 && s['lipFullnessRatio']!.abs() <= 1,
  ...
  _InteractionRule('T-R1',
      (s) => s['nasalHeightRatio']! >= 2 && s['mouthCornerAngle']! >= 2,
      {Attribute.trustworthiness: 2.5}),
  _InteractionRule('T-R2', (s) => s['browEyeDistance']! >= 2 && s['eyebrowThickness']! >= 2,
      {Attribute.trustworthiness: 2.0}),
  _InteractionRule('T-R3',
      (s) => s['nasalHeightRatio']! <= -2 && s['mouthCornerAngle']! <= -2,
      {Attribute.trustworthiness: -1.5}),
  _InteractionRule('T-R4', (s) => s['intercanthalRatio']! >= 2 && s['browEyeDistance']! <= -2,
      {Attribute.trustworthiness: -2.0}),
  _InteractionRule('T-R5',
      (s) => s['eyebrowThickness']! >= 2 && s['nasalHeightRatio']! >= 2,
      {Attribute.trustworthiness: 1.5}),
  ...
  _InteractionRule('T-R7',
      (s) => s['browEyeDistance']! <= -2 && s['mouthCornerAngle']! >= 2,
      {Attribute.trustworthiness: 0.5}),

  // Attractiveness (5)
  _InteractionRule('AT-R1',
      (s) => s['mouthCornerAngle']! >= 2 && s['eyeCanthalTilt']! >= 2 && s['lipFullnessRatio']! >= 0,
  ...
  _InteractionRule('AT-R3', (s) => s['eyeFissureRatio']! >= 2 && s['eyeCanthalTilt']! >= 0,
      {Attribute.attractiveness: 1.5}),
  _InteractionRule('AT-R4', (s) => s['mouthCornerAngle']! <= -2 && s['eyeCanthalTilt']! <= -2,
      {Attribute.attractiveness: -2.0}),
  _InteractionRule('AT-R5',
      (s) => s['nasalHeightRatio']! >= 2 && s['nasalWidthRatio']! <= -2,
  ...
  _InteractionRule('AT-R7',
      (s) => s['eyeFissureRatio']! >= 2 && s['mouthCornerAngle']! <= -2,
      {Attribute.attractiveness: 1.0}),

  // Libido (5)
  _InteractionRule('LB-R1', (s) => s['philtrumLength']! <= -2 && s['lipFullnessRatio']! >= 2,
      {Attribute.libido: 3.0}),
  _InteractionRule('LB-R2',
      (s) => s['nasalWidthRatio']! >= 2 && s['nasalHeightRatio']! >= 2,
      {Attribute.libido: 2.0}),
  _InteractionRule('LB-R3', (s) => s['philtrumLength']! <= -2 && s['nasalWidthRatio']! >= 2,
      {Attribute.libido: 2.0}),
  _InteractionRule('LB-R4', (s) => s['philtrumLength']! >= 2 && s['lipFullnessRatio']! <= -2,
      {Attribute.libido: -2.0}),
  _InteractionRule('LB-R5', (s) => s['eyeCanthalTilt']! >= 2 && s['lipFullnessRatio']! >= 2,
...
final _genderRules = <_GenderRule>[
  ...
  _GenderRule('GM-R1', Gender.male,
      (s) => s['gonialAngle']! >= 2 && s['eyebrowThickness']! >= 2,
      {Attribute.leadership: 2.0, Attribute.attractiveness: 1.0}),
  _GenderRule('GM-R2', Gender.male,
      (s) => s['nasalWidthRatio']! >= 2 && s['gonialAngle']! >= 2,
      {Attribute.wealth: 1.5}),
  _GenderRule('GM-R3', Gender.male,
      (s) => s['philtrumLength']! <= -2 && s['nasalWidthRatio']! >= 2,
      {Attribute.libido: 2.0}),
...
final _ageRules = <_AgeRule>[
  _AgeRule('AG-R1', (s, sAdj) => sAdj['mouthCornerAngle']! >= 2,
      {Attribute.stability: 2.0, Attribute.attractiveness: 1.5}),
  _AgeRule('AG-R2', (s, sAdj) => sAdj['browEyeDistance']! >= 2 && sAdj['lipFullnessRatio']! >= 0,
      {Attribute.attractiveness: 1.5}),
  _AgeRule('AG-R3', (s, sAdj) => sAdj['philtrumLength']! <= -2,
      {Attribute.libido: 1.5, Attribute.sensuality: 1.0}),
  _AgeRule('AG-R4', (s, sAdj) => sAdj['lipFullnessRatio']! >= 2,
      {Attribute.emotionality: 1.5, Attribute.sensuality: 1.0}),
  _AgeRule('AG-R5', (s, sAdj) => sAdj['mouthCornerAngle']! <= -2 && sAdj['browEyeDistance']! <= -2,
      {Attribute.stability: -1.5}),
];
